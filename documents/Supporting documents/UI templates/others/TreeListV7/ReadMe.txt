========================================================================
       MICROSOFT FOUNDATION CLASS BIBLIOTHEK : TreeList
========================================================================


Diese TreeList-Anwendung hat der Klassen-Assistent für Sie erstellt. Diese Anwendung
...
Ihre TreeList-Anwendung bilden.
...
res\TreeList.ico
	...
	Symbol wird durch die Haupt-Ressourcendatei TreeList.rc eingebunden.
...
TreeListDlg.h, TreeListDlg.cpp - das Dialogfeld
    	Diese Dateien enthalten die Klasse CTreeListDlg. Diese Klasse legt das
    	Verhalten des Haupt-Dialogfelds der Anwendung fest. Die Vorlage des Dialog-
	felds befindet sich in TreeList.rc, die mit Microsoft Visual C++
...
StdAfx.h, StdAfx.cpp
	...
	TreeList.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj
	erstellt.
