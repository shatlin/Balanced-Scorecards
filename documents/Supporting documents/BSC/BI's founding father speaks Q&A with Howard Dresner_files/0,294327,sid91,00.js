 //- searchDataManagement Javascript File -
...
if(91 == 96 || 91 == 97 || 91 == 98 || 91 == 99 || 91 == 100) var CHANNELHEADER = "on"; else CHANNELHEADER = "off";
var SID = 91;
	function HEADER_CHANNEL() {
		...
		document.write('<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="9" height="43" alt=""></td>');
		document.write('<td width="100%" valign="top"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="10" alt=""><br>');
		document.write('<a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/header_logo.gif" border="0" alt=""></a></td>');
		document.write('<td rowspan="2" align="right" valign="top"><img src="http://media.techtarget.com/searchDataManagement/images/header_background.gif" width="297" height="68" alt="" border="0"></td>');
		document.write('</tr>');
		document.write('<tr class="colorHeader">');
		document.write('<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="16" border="0" alt=""></td>');
		document.write('<td valign="top"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="59" height="1" alt=""><a href="http://www.techtarget.com"><img src="http://media.techtarget.com/searchDataManagement/images/header_tagline.gif" alt="Part of the IT Channel TechTarget Sites" border="0"></a></td>');
		document.write('</tr>');
	...
	function HEADER_CHANNEL_TABS() {
		...
		document.write('<td background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif" width="8" height="22" alt=""></td>');
		document.write('<td background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><a href="http://searchitchannel.techtarget.com/"><img src="http://media.techtarget.com/searchDataManagement/images/tab_it_channel' + sid96size + '.gif" alt="IT Channel" border="0"></a></td>');
		document.write('<td align="center" background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif" alt=""></td>');
		document.write('<td background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><a href="http://searchnetworkingchannel.techtarget.com/"><img src="http://media.techtarget.com/searchDataManagement/images/tab_networking_channel' + sid100size + '.gif" alt="Networking Channel" border="0"></a></td>');
		document.write('<td align="center" background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif" alt=""></td>');
		document.write('<td background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><a href="http://searchsecuritychannel.techtarget.com/"><img src="http://media.techtarget.com/searchDataManagement/images/tab_security_channel' + sid97size + '.gif" alt="Security Channel" border="0"></a></td>');
		document.write('<td align="center" background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif" alt=""></td>');
		document.write('<td background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><a href="http://searchstoragechannel.techtarget.com/"><img src="http://media.techtarget.com/searchDataManagement/images/tab_storage_channel' + sid98size + '.gif" alt="Storage Channel" border="0"></a></td>');
		document.write('<td align="center" background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif" alt=""></td>');
		document.write('<td background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><a href="http://searchsystemschannel.techtarget.com/"><img src="http://media.techtarget.com/searchDataManagement/images/tab_systems_channel' + sid99size + '.gif" alt="Systems Channel" border="0"></a></td>');
		document.write('<td align="center" background="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_separator.gif" alt=""></td>');
		document.write('</tr>');
		document.write('</table>');
	...
	function FOOTER_CHANNEL_TABS() {
		document.write('<table border="0" cellspacing="0" cellpadding="0" width="100%">');
		document.write('<tr class="colorHeader">');
		document.write('<td colspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3" alt=""></td>');
		document.write('</tr>');
		document.write('</table>');
		HEADER_CHANNEL_TABS();
	}
 	...
 	function HEADER_DISPLAY_CODE_0() {
		...
		if(CHANNELHEADER == "on")
			...
			'<tr class="color0"><td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3" alt=""></td></tr>'+
			'</table>');
			if (!ISHOME && SPONSORBANNER == "on") document.write(SPONSOR_BANNER());
			...
			'<tr>'+
			'<td width="100%"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="15" alt=""></td>'+
			'</tr>'+
			'</table>');
		}
	...
	function PORTFOLIO_BAND_DISPLAY_CODE_0() {
		...
		if (ipcON == "onREMOVEWHENRELEASED") {
			...
			ipcInboxURL = "http://searchDataManagement.techtarget.com/ITKnowledgeExchange/inbox/0,,sid91_ipu"+
			...
			'<tr class="'+portStyle+'">',
			'<td colspan="10"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3"></td>',
			'</tr>',
			'<tr class="'+portStyle+'">',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="15"></td>',
			...
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="15" height="1"></td>',
			'<td><img src="http://media.techtarget.com/digitalguide/images/Misc/envelope_small.gif" border="0"></a><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" height="1" width="3"></td>',
			'<td nowrap><span class="a2"><span class="textC">'+(
				// IPC MESSAGE COUNT
				(handle == '') ? 'You have <a href="http://searchDataManagement.techtarget.com/ITKnowledgeExchange/0,294907,sid91,00.html" class="textC"><span class="a2">'+
			...
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" height="1" width="10"></td>',
			'<td nowrap><a href="http://searchDataManagement.techtarget.com/register/1,289568,sid91,00.html" class="'+textStyle+'"><span class="a2">'+(
				// LOGIN-OUT / EDIT PROFILE LINKS
				(ttUser == -1) ? '<b>Register Now</b></span></a>&nbsp;&nbsp;<font class="textF">|</font>&nbsp;&nbsp;<a href="'+
				((ALTLOGIN != "no") ? ALTLOGIN : 'http://searchDataManagement.techtarget.com/login/1,289498,sid91,00.html')+'" class="'+textStyle+'"><span class="a2"><b>Log-in</b>' :
				(thisSite == -1) ? '<b>Add this site to your TechTarget Member Profile</b>' :
				'<b>Edit Profile</b></span></a>&nbsp;&nbsp;<font class="textF">|</font>&nbsp;&nbsp;<a href="'+
				((ALTLOGOUT != "no") ? ALTLOGOUT : 'http://searchDataManagement.techtarget.com/logout/1,289500,sid91,00.html')+'" class="'+textStyle+'"><span class="a2"><b>Log-out</b>'
			)+'</span></a></td>',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1"></td>',
			'</tr>',
			'<tr class="'+portStyle+'">',
			'<td colspan="10"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3"></td>',
			'</tr>',
			...
			'<tr class="'+portStyle+'"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3"></td></tr>',
			'<tr class="'+portStyle+'">',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="15"></td>',
			...
			'<a href="http://searchDataManagement.techtarget.com/register/1,289568,sid91,00.html" class="'+textStyle+'"><span class="a2">Edit your Profile</span></a>&nbsp;<span class="yellow">|</span>&nbsp;'+
			'<a href="'+((ALTLOGOUT != "no") ? ALTLOGOUT : 'http://searchDataManagement.techtarget.com/logout/1,289500,sid91,00.html')+'" class="'+textStyle+'"><span class="a2">Log-out</span></a>' :
			'<a href="http://searchDataManagement.techtarget.com/register/1,289568,sid91,00.html" class="'+textStyle+'"><span class="a2">Activate your FREE membership today</span></a>&nbsp;<span class="yellow">|</span>&nbsp;'+
			'<a href="'+((ALTLOGIN != "no") ? ALTLOGIN : 'http://searchDataManagement.techtarget.com/login/1,289498,sid91,00.html')+'" class="'+textStyle+'"><span class="a2">Log-in</span></a>')+'</span>' : '&nbsp;')+
			'</td>',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1"></td>',
			'</tr>',
			'<tr class="'+portStyle+'"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3"></td></tr>',
			'<tr class="'+lineStyle+'"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1"></td></tr>',
			'<tr class="'+portStyle+'"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1"></td></tr>',
			'</table>');
		}
		return pfoBand.join("");
	}
		...
		if (hasImage) {
			...
			switch (mediaCode) {
				case "MCW": links.push(
					...
					' href="http://searchDataManagement.techtarget.com/mediaPopup/0,295511,sid91_tab1,00.html" alt="Magazine"'+
					' target="'+popupWinName+'" onClick="window.open(\'about:blank\',\''+popupWinName+'\',\''+popupWinProp+'\')">',
					'<area shape="rect" coords="150,36 229,47"'+
					' href="http://searchDataManagement.techtarget.com/mediaPopup/0,295511,sid91_tab2,00.html" alt="Conferences"'+
					' target="'+popupWinName+'" onClick="window.open(\'about:blank\',\''+popupWinName+'\',\''+popupWinProp+'\')">',
					'<area shape="rect" coords="237,36 296,47"'+
					' href="http://searchDataManagement.techtarget.com/mediaPopup/0,295511,sid91_tab3,00.html" alt="Web Sites"'+
					' target="'+popupWinName+'" onClick="window.open(\'about:blank\',\''+popupWinName+'\',\''+popupWinProp+'\')">');
					break;
				case "MW": links.push(
				...
				case "W": links.push(
					...
					' href="http://searchDataManagement.techtarget.com/mediaPopup/0,295511,sid91_tab1,00.html" alt="Web Sites"'+
					' target="'+popupWinName+'" onClick="window.open(\'about:blank\',\''+popupWinName+'\',\''+popupWinProp+'\')">');
					break;
			} links.push('<area shape="default" nohref alt="">',
			'</map>',
			'<img src="http://media.techtarget.com/searchDataManagement/images/header_mediaLinks_W.gif" width="300" height="59" ismap usemap="#headermap" alt="TechTarget CRM Media" border="0">');
			return links;
		} else return new Array('<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="290" height="6" alt="" border="0">');
	}
	...
	function LEADER_BOARD_DISPLAY_CODE_0() {
		...
		'<tr class="colorC">');
		if (!ISFIXEDWIDTH) board.push('<td width="50%" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>');
		board.push('<td colspan="7"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="10" alt=""></td>',
		'<td width="100%" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>',
		'</tr>','<tr class="colorF">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="19" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="728" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="19" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr>',
		'<td class="colorF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		...
		'<td class="colorF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td align="center" valign="top" background="http://media.techtarget.com/digitalguide/images/Misc/background_ad_side_728_90.gif">'+
		'<img name="toggle728x90" src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="19" height="90" border="0" alt=""></td>',
		'<td class="colorF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr class="colorF">',
		'<td colspan="7"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr class="colorC">',
		'<td colspan="7"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="10" alt=""></td>',
		'</tr>',
		'</table>',
		'<table border="0" cellspacing="0" cellpadding="0" width="100%">',
		'<tr class="color0">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3" alt=""></td>',
		'</tr>',
		'</table>');
		//window.alert(board);
		return board.join("");
	...
	function HEADER_SEARCH_CHANNEL() {
		...
		'</table>',
		'<table border="0" cellspacing="0" cellpadding="0" width="100%">',
		'<form action="http://searchDataManagement.techtarget.com/search/1,293876,sid91,00.html">',
		'<tr class="colorEF">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="7" height="25" alt=""></td>',
		'<td nowrap class="a2"><span class="text6"><b>SEARCH this site and the web</b></span></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="9" height="1" alt=""></td>',
		'<td><input type="text" name="query" size="8" class="i3width125"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="7" height="1" alt=""></td>',
		'<td><input type="image" src="http://media.techtarget.com/digitalguide/images/Misc/button_search_cccccc.gif"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="9" height="1" alt=""></td>',
		'<td nowrap><a href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html" class="text6"><span class="a1">ADVANCED SEARCH</span></a>&nbsp;&nbsp;',
		'<span class="textF"><span class="a2">|</span></span>&nbsp;&nbsp;',
		'<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="text6"><span class="a1">SITE INDEX</span></a></td>',
		'<td width="100%"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		...
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="3" height="1" alt=""></td>',
		'<td>',
		'</tr>',
		'</form>',
		'</table>',
	...
	function HEADER_SEARCH_DISPLAY_CODE_0() {
		...
		'<form name="search" action="http://searchDataManagement.techtarget.com/search/1,293876,sid91,00.html" method="get">',
		'<tr class="color0">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="7" height="25" alt=""></td>',
		...
		'<td><input type="image" src="http://media.techtarget.com/digitalguide/images/Misc/button_search_cccccc.gif"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="9" height="1" alt=""></td>',
		'<td nowrap><a href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html" class="textF"><span class="a1">ADVANCED SEARCH</span></a>&nbsp;&nbsp;',
		'<span class="textF"><span class="a2">|</span></span>&nbsp;&nbsp;',
		'<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="textF"><span class="a1">SITE INDEX</span></a></td>',
		'<td width="100%"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	...
	function HEADER_SEARCH_CLICKTHRU_DISPLAY_CODE_0() {
		...
		'<form name="search" action="http://searchDataManagement.techtarget.com/search/1,293876,sid91,00.html" method="get">',
		'<tr class="color0">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="25" alt=""></td>',
		'<td nowrap class="a2"><span class="textF"><b>SEARCH</b></span></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="7" height="1" alt=""></td>',
		'<td><input type="text" name="query" size="8" class="i3width125"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="1" alt=""></td>',
		'<td><input type="image" src="http://media.techtarget.com/digitalguide/images/Misc/button_search_cccccc.gif"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="7" height="1" alt=""></td>',
		'</form>',
		'<td nowrap><a href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html" class="textF"><span class="a1">ADVANCED SEARCH</span></a>',		'&nbsp;&nbsp;<span class="textF"><span class="a2">|</span></span>&nbsp;&nbsp;<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="textF"><span class="a1">SITE INDEX</span></a></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><a href="http://www.google.com"><img src="http://media.techtarget.com/digitalguide/images/Misc/searchPoweredByGoogle_onBlack.gif" width="147" height="23" alt="Search Powered by Google" border="0"></a></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/digitalguide/images/Misc/homepageHeader_background_onBlack.gif"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1" alt=""></td>',
		'<td nowrap class="a2"><span class="textF"><b><a href="http://searchDataManagement.techtarget.com/clickThruAbout/0,296381,sid91,00.html"><img src="http://media.techtarget.com/digitalguide/images/Misc/clickthru_logo.gif" border="0"></a></b></span></td>',
	...
	function SPONSOR_BANNER_DISPLAY_CODE_0() {
		...
		'<tr><td colspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="15"></td></tr>',
		'<tr>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1"></td>',
	...
	function PAGE_NAVIGATION() {
		...
		'<tr class="colorNav">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>'), links = new Array();
		
		
		
		     if (!ISHOME) links.push('<td><a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_home.gif" width="30" height="22" alt="Home" border="0"></a></td>');
		  links.push('<td><a href="http://searchDataManagement.techtarget.com/news/0,289141,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_news.gif" width="30" height="22" border="0" alt="News"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.techtarget.com/topicsMain/0,295490,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_topics.gif" width="37" height="22" border="0" alt="Topics"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.techtarget.com/ITKnowledgeExchange/0,294907,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_itke.gif" width="135" height="22" border="0" alt="ITKnowledge Exchange"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.techtarget.com/tips/0,289484,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_tips.gif" width="23" height="22" border="0" alt="Tips"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.techtarget.com/expert/Knowledgebase/0,289622,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_ate.gif" width="94" height="22" border="0" alt="Ask the Experts"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.techtarget.com/webcasts/0,295024,sid91,00.html?asrc=SS_NAV_WC"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_webcasts.gif" width="57" height="22" border="0" alt="Webcasts"></a></td>');
		     links.push('<td><a href="http://searchDataManagement.bitpipe.com/?asrc=SS_NAV_WP"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_whitepapers.gif" width="76" height="22" border="0" alt="White Papers"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.bitpipe.com/productdirectory.html?asrc=SS_NAV_PR"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_products.gif" width="56" height="22" border="0" alt="Products"></a></td>');
		    nav.push(links.join('<td align="center" width="5%"><img src="http://media.techtarget.com/searchDataManagement/images/homeNav_separator.gif" width="2" height="22" alt=""></td>'));
		nav.push('<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>','</tr>','</table>','</div>');
		return nav.join("");
	}
 function PAGE_FOOTER_TOP_DISPLAY_CODE_0 () {}
	...
	function PAGE_FOOTER_BOTTOM_DISPLAY_CODE_0() {
		...
		if ((FOOTERLINKS == "on" || FOOTERSEARCH == "on") && JSdigitalGuideID != 63) {
			...
			'</tr>'+
			'<tr class="' + trClass + '">'+
			'<td colspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="5"></td>'+
			'</tr>'+
			'</table>');
		} else {
			document.write('<table border="0" cellpadding="0" cellspacing="0" width="100%">'+
			'<tr class="' + trClass + '">'+
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="7"></td>'+
			'</tr>'+
			'</table>');
		}
	 ...
	 function FOOTER_LINKS_DISPLAY_CODE_0() {
		var links = new Array('<a href="http://searchDataManagement.techtarget.com/aboutUs/0,289153,sid91,00.html" class="textOnColor1">About Us</a>',
		'<a href="http://searchDataManagement.techtarget.com/contactUs/0,289157,sid91,00.html" class="textOnColor1">Contact Us</a>',
		'<a href="http://searchDataManagement.techtarget.com/buyersGuideForVendors/0,289879,sid91,00.html" class="textOnColor1">For Advertisers</a>',
		'<a href="http://searchDataManagement.techtarget.com/forBusinessPartners/0,289198,sid91,00.html" class="textOnColor1">For Business Partners</a>',
		
			'<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="textOnColor1">Site Index</a>',
		 '<a href="http://searchDataManagement.techtarget.com/rssLanding/0,295701,sid91,00.html" class="textOnColor1">RSS</a>');
		 return links.join('&nbsp;&nbsp;|&nbsp;&nbsp;');
	}
	...
	function PORTFOLIO_BOX_DISPLAY_CODE_0() {
		...
		var box = new Array('<style type="text/css">',
							...
							'<tr>',
							'<td style="font: normal 11px arial">TechTarget provides enterprise IT professionals with the information they need to perform their jobs - from developing strategy, to making cost-effective IT purchase decisions and managing their organizations IT projects - with its network of <a href="javascript:portfolioWindow(\'http://searchdatamanagement.techtarget.com/portfolioSites/0,296825,sid91,00.html\')" class="footerLink">technology-specific Web sites, events and magazines</a>.</td>',
							'</tr>',
							'</table>',
							...
							links.push('<a href="http://www.techtarget.com/" class="footerLink">TechTarget Corporate Web Site</a>',
										...
										'<a href="http://searchDataManagement.techtarget.com/reprints/0,296569,sid91,00.html" class="footerLink">Reprints</a>');
							 links.push('<a href="http://searchDataManagement.techtarget.com/sitemap/0,296817,sid91,00.html" class="footerLink">Site Map</a>');
							box = box.concat(links.join('&nbsp;&nbsp;|&nbsp;&nbsp;'));							
							box.push('<br><br><br><br><br>All Rights Reserved, <a href="http://searchDataManagement.techtarget.com/copyright/0,289135,sid91,00.html" class="footerLink">Copyright 2005 - 2007</a>, TechTarget&nbsp;|&nbsp;<a href="http://www.techtarget.com/html/privacy_policy.html" class="footerLink" target=_>Read our Privacy Policy</a>',
							'</td>',
							'<td width="100%">&nbsp;</td>',
							'<td valign="top"><a href="http://www.techtarget.com"><img src="http://media.techtarget.com/digitalguide/images/Misc/tt_footer_logo.gif" width="97" height="92" border="0" alt="TechTarget - The Most Targeted IT Media"></a></td>',
							'</tr>',
							'</table>',
							'</td>',
							'</tr>',
...
function SPONSOR_BANNER_DISPLAY_CODE_1() {
		...
		'<tr>',
		'<td width="100%"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td align="right" rowspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/header_portfolioBand_curveEnd.gif" width="25" height="36" alt=""></td>',
		'</tr>',
		'<tr>',
		'<td>',
		'<table border="0" cellpadding="0" cellspacing="0" width="100%">',
		'<tr>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/label_portfolioBand.gif" width="14" height="33" alt="Ad"></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td>'+PAGE_AD(9)+'</td>',
		'</tr>',
		'</table>',
		...
		'</tr>',
		'<tr>',
		'<td class="color9"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="745" height="1" alt=""></td>',
		'</tr>',
		'</table>').join("");
	}
...
function PORTFOLIO_BAND_DISPLAY_CODE_1() {
	...
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="14" alt=""></td>',
	...
	'<td nowrap align="right"><span class="textOnColorPortfolioBand">'+((USERINFO == "on") ? '<span class="textOnColorPortfolioBand">'+((loggedIn != -1) ? '<span class="h2"><i>You\'re logged in as:</i> '+DisplayName+'</span>&nbsp;'+
			'<a href="http://searchDataManagement.techtarget.com/register/1,289568,sid91,00.html" class="textOnColorPortfolioBand2"><span class="h2">Edit your Profile</span></a>&nbsp;<span class="yellow">|</span>&nbsp;'+
			'<a href="'+((ALTLOGOUT != "no") ? ALTLOGOUT : 'http://searchDataManagement.techtarget.com/logout/1,289500,sid91,00.html')+'" class="textOnColorPortfolioBand2"><span class="h2">Log-out</span></a>' :
			...
			'<a href="'+((ALTLOGIN != "no") ? ALTLOGIN : 'http://searchDataManagement.techtarget.com/login/1,289498,sid91,00.html')+'" class="textOnColorPortfolioBand2"><span class="h2">Log-in</span></a>')+'</span></span>' : '&nbsp;')+
	'</span></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="3" height="1" alt=""></td>',
	'<td rowspan="4" class="color1"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="11" height="1" alt=""></td>',
	'</tr>',
	'<tr class="colorPortfolioBand">',
	'<td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="2" alt=""></td>',
	'</tr>',
	'<tr class="color6">',
	'<td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'</tr>',
	'<tr class="colorPortfolioBand">',
	'<td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="2" alt=""></td>',
	'</tr>',
...
'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="56" alt=""></td>',
'<td valign="middle">');
	if (LOGO == "on") core.push('<a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/header_siteLogo.gif" alt="searchDataManagement" border="0"></a>');
	core.push ('</td>',
	'<td width="100%"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td>');
	...
	else core.push('<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="208" height="56" alt="">');
	core.push('</td>',
	'<td rowspan="99" class="'+mediaClass+'"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>',
...
function LEADER_BOARD_DISPLAY_CODE_1() {
	var board = new Array('<table border="0" cellpadding="0" cellspacing="0" width="100%">',
	'<tr class="colorF">',
	'<td valign=top><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="14" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="728" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="106" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td rowspan="99" class="color1"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'<tr>',
	'<td class="colorF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	...
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td align="center" valign="top" background="http://media.techtarget.com/digitalguide/images/Misc/background_ad_side_728_90.gif">',
	'<img name="toggle728x90" src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="16" height="90" border="0" alt="">',
	'</td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'</tr>',
	'<tr class="colorF">',
...
function FOOTER_LINKS_DISPLAY_CODE_1() {
	...
	'<a href="http://searchDataManagement.techtarget.com/buyersGuideForVendors/0,289879,sid91,00.html" class="textOnColor1">For Advertisers</a>',
	'<a href="http://searchDataManagement.techtarget.com/forBusinessPartners/0,289198,sid91,00.html" class="textOnColor1">For Business Partners</a>',
	'<a href="http://searchDataManagement.techtarget.com/reprints/0,296569,sid91,00.html" class="textOnColor1">Reprints</a>',
	'<a href="http://searchDataManagement.techtarget.com/rssLanding/0,295701,sid91,00.html" class="textOnColor1">RSS</a>');
	 return links.join('&nbsp;&nbsp;|&nbsp;&nbsp;');
}
...
function PAGE_NAVIGATION_DISPLAY_CODE_1(position) {
	...
	if (!ISHOME) {
		links.push('<span id="navList" class="first"><a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html" class="navLink">HOME</a></span>');
		spanClass = '';
	}
	  links.push('<span id="navList"' + spanClass + '><a href="http://searchDataManagement.techtarget.com/news/0,289141,sid91,00.html" class="navLink">NEWS</a></span>');
		spanClass = '';
		   links.push('<span id="navList"' + spanClass + '><a href="http://searchDataManagement.techtarget.com/topicsMain/0,295490,sid91,00.html" class="navLink">TOPICS</a></span>');
		spanClass = '';
		         links.push('<span id="navList"' + spanClass + '><a href="http://searchDataManagement.techtarget.com/webcasts/0,295024,sid91,00.html?asrc=SS_NAV_WC" class="navLink">WEBCASTS</a></span>');
		spanClass = '';
		     links.push('<span id="navList"' + spanClass + '><a href="http://searchDataManagement.bitpipe.com/?asrc=SS_NAV_WP" class="navLink">WHITE PAPERS</a></span>');
		spanClass = '';
		      nav.push(links.join(''));
	nav.push('</div>');
	if(position == 'bottom') nav.push('<td valign="top"><img src="http://media.techtarget.com/searchDataManagement/images/footer_curveEnd_bottom.gif" width="25" height="19" alt=""></td>');
	else if(position == 'top') nav.push('<td valign="top"><img src="http://media.techtarget.com/searchDataManagement/images/header_curveEnd_top.gif" width="25" height="19" alt=""></td>');
...
function COLOR1_LINE_DISPLAY_CODE_1 () {
	...
	'<tr class="color1">',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3" border="0" alt=""></td>',
	'</tr></table>');
...
function STRIPE_DISPLAY_CODE_1(position) {	
	...
	'<tr>',
	'<td width="100%" align="right" class="color1"><img src="http://media.techtarget.com/searchDataManagement/images/header_gradient_860.gif" width="835" height="8" alt=""></td>');
	if(position == 'bottom') stripe.push('<td background="http://media.techtarget.com/searchDataManagement/images/footer_curveEnd_middle.gif" class="color1">');
	else if(position == 'top') stripe.push('<td background="http://media.techtarget.com/searchDataManagement/images/header_curveEnd_middle.gif" class="color1">'); 
	stripe.push('<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="25" height="8" alt="">',
	'</td>',
	'</tr>',
	'</table>');
	return stripe.join("");
...
function SEARCHBOX_DISPLAY_CODE_1(position) {
	...
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="24" alt=""></td>',
	'<td nowrap><span class="h2"><span class="textF"><b>Search</b> this site and the web:</span></span></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="6" height="1" alt=""></td>',
	'<td>',
	'<table border="0" cellspacing="0" cellpadding="0">',
	'<form name="search" action="http://searchDataManagement.techtarget.com/search/1,293876,sid91,00.html" method="get">',
	'<tr>',
	...
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="3" height="1" alt=""></td>',
	'<td><input type="image" src="http://media.techtarget.com/searchDataManagement/images/button_go.gif"></td>',
	'</tr>',
	'</tr>',
	'</table>',
	'</td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="10" height="1" alt=""></td>',
	'<td nowrap>',
	'<a href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html" class="searchbarLink">ADVANCED SEARCH</a>',
	'&nbsp;&nbsp;<span class="textF"><span class="h2">|</span></span>&nbsp;&nbsp;',
	'<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="searchbarLink">SITE INDEX</a>',
	'</td>',
	'<td width="100%"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColor6.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="24" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	...
	'<!--<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="1" alt=""></td>-->');
	if(position == 'bottom'){
		if(JSfooterAdSense == 'on') searchbox.push('<td background="http://media.techtarget.com/searchDataManagement/images/footer_curveEnd_top_onColor9.gif">');
		else searchbox.push('<td background="http://media.techtarget.com/searchDataManagement/images/footer_curveEnd_top.gif">');
	}
	else if(position == 'top') searchbox.push('<td background="http://media.techtarget.com/searchDataManagement/images/header_curveEnd_bottom.gif">');
	searchbox.push('<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="25" height="24" alt=""></td>',	
	'</tr>',	
	'</form></table>',	
...
function SEARCHBOX_CLICKTHRU_DISPLAY_CODE_1(position) {
	searchbox = new Array('<!-- BEGIN: search bar -->',
			...
			'</td>',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
			'<td nowrap><a href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html" class="searchbarLink">ADVANCED SEARCH</a>&nbsp;&nbsp;<span class="textF"><span class="h2">|</span></span>&nbsp;&nbsp;<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="searchbarLink">SITE INDEX</a></td>',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="15" height="1" alt=""></td>',
			'<td><a href="http://www.google.com"><img src="http://media.techtarget.com/digitalguide/images/Misc/searchPoweredByGoogle_onGrey6.gif" width="149" height="24" alt="Search Powered by Google" border="0"></a></td>',
			'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="83" height="1" alt=""></td>',
	'<!-- END: search bar -->');
		if(position == 'bottom'){
		searchbox.push('<!-- BEGIN: ClickThru Form Header Footer-->',
					'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColor6.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="24" alt=""></td>',
					'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="1" alt=""></td>',
					'<td><a href="http://searchDataManagement.techtarget.com/clickThruAbout/0,296381,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/clickthru_logo.gif" width="91" height="16" alt="CLICKTHRU" border="0"></a></td>',
					'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>',
					'<td>',
						'<table border="0" cellspacing="0" cellpadding="0">',
						...
						'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="3" height="1" alt=""></td>',
						'<td><input type="image" src="http://media.techtarget.com/searchDataManagement/images/button_go.gif" action="submit"></td>',
						'</tr>',
						'</form>',
						'</table>',
					'</td>',
			...
			if(JSfooterAdSense == 'on') searchbox.push('<td background="http://media.techtarget.com/searchDataManagement/images/footer_curveEnd_top_onColor9.gif">');
				...
				'<!-- BEGIN: ClickThru Form Header Footer-->',
					...
					'</td>',
			'<!--END: ClickThru Form Header Footer-->',
		'<td background="http://media.techtarget.com/searchDataManagement/images/header_curveEnd_bottom.gif">');
...
function PORTFOLIO_BOX_DISPLAY_CODE_1() {
	...
	'<tr class="color6">',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="19" alt=""></td>',
	'<td width="100%">&nbsp;</td>',
	'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColor6.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="19" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="174" height="19" alt=""></td>',
	'<td class="color1"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>',
	'<table border="0" cellpadding="0" cellspacing="0" width="100%">',
	'<tr>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="10" height="40" alt=""></td>',
	'<td width="100%" style="font: normal 11px tahoma">TechTarget provides enterprise IT professionals with the information they need to perform their jobs - from developing strategy, to making cost-effective IT purchase decisions and managing their organizations\' IT projects - with its <a href="javascript:portfolioWindow(\'http://searchdatamanagement.techtarget.com/portfolioSites/0,296825,sid91,00.html\')" class="footerLink">network of technology-specific Web sites, events and magazines.</a></td>',
	'<td class="color1"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>',
	'<table border="0" cellspacing="0" cellpadding="0" width="100%">',
	'<tr class="colorFooter">',
	'<td rowspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="10" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="634" height="20" alt=""></td>',
	'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColorEF.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="20" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="174" height="20" alt=""></td>',
	'<td rowspan="99" class="color1"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'<tr class="colorFooter">',
	'<td valign="top">',
	...
	links = new Array();
	links.push('<a href="http://searchDataManagement.techtarget.com/buyersGuideForVendors/0,289879,sid91,00.html" class="footerLink">For Advertisers</a>',
				'<a href="http://www.techtarget.com/mediakit/" class="footerLink">Media Kit</a>',
				'<a href="/ciodCalendar/0,296143,sid91,00.html" class="footerLink">Editorial Calendar</a>',
				'<a href="http://searchDataManagement.techtarget.com/sitemap/0,296817,sid91,00.html" class="footerLink">Site Map</a>',
	...
	'</table>',
	'</td>',
	'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColorEF.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="1" alt=""></td>',
	'<td valign="top">',
	'<table border="0" cellspacing="0" cellpadding="0" width="100%">',
	'<tr>',
	'<td rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="10" height="1" alt=""></td>',
	'<td colspan="3" align="left">',
	'<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="35" height="1" alt="">',
	'<a href="http://www.techtarget.com"><img src="http://media.techtarget.com/digitalguide/images/Misc/footer_tt_logo_onColorEF.gif" width="77" height="74" border="0" alt="TechTarget - The Most Targeted IT Media"></a>',
	'</td>',
	'<td rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
	'</tr>',
	'<tr>',
	'<td colspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="15" alt=""></td>',
	'</tr>',
	'</table>',
	'</td>',
	'</tr>',
	'<tr class="colorFooter">',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="30" alt=""></td>',
	'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColorEF.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="30" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="30" alt=""></td>',
	'</tr>',
	'</table>',
	'<table border="0" cellpadding="0" cellspacing="0" width="100%">',
	...
	'<tr class="color3">',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="19" alt=""></td>',
	'<td width="100%"><span class="h2"><span class="textF">All Rights Reserved, <a href="http://searchDataManagement.techtarget.com/copyright/0,289135,sid91,00.html" class="footerLink2"><span class="h2">Copyright 2005 - 2007</span></a>, TechTarget</span></span></td>',
	'<td background="http://media.techtarget.com/searchDataManagement/images/background_lineTrio_onColor3.gif"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="34" height="24" alt=""></td>',
	'<td align="right"><a href="http://www.techtarget.com/html/privacy_policy.html" target="_blank" class="footerLink2"><span class="h2">Read our Privacy Policy</span></a><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>');
	return box.join("");
}
	...
	function MEDIA_LINKS_DISPLAY_CODE_1() {
		...
		if (hasImage) {
			...
			'</map>',
			'<img src="http://media.techtarget.com/searchDataManagement/images/header_mediaSections_W.gif" width="208" height="56" ismap usemap="#headermap" alt="TechTarget CRM Media" border="0">');
			return links;
		} else return new Array('<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="208" height="58" alt="" border="0">');
	}
...
function PORTFOLIO_BAND_DISPLAY_CODE_3() {
	...
	'<tr class="crmColorPortfolioBand"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3"></td></tr>',
	...
	'<a href="http://searchDataManagement.techtarget.com/register/1,289568,sid91,00.html" class="crmTxOnColorPortfolioBand"><span class="a2">Edit your Profile</span></a>&nbsp;<span class="yellow">|</span>&nbsp;'+
	'<a href="'+((ALTLOGOUT != "no") ? ALTLOGOUT : 'http://searchDataManagement.techtarget.com/logout/1,289500,sid91,00.html')+'" class="crmTxOnColorPortfolioBand"><span class="a2">Log-out</span></a>' :
	'<a href="http://searchDataManagement.techtarget.com/register/1,289568,sid91,00.html" class="crmTxOnColorPortfolioBand"><span class="a2">Activate your FREE membership today</span></a>&nbsp;<span class="yellow">|</span>&nbsp;'+
	'<a href="'+((ALTLOGIN != "no") ? ALTLOGIN : 'http://searchDataManagement.techtarget.com/login/1,289498,sid91,00.html')+'" class="crmTxOnColorPortfolioBand"><span class="a2">Log-in</span></a>')+'</span>' : '&nbsp;')+
	'</td>',
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1"></td>',
	'</tr>',
	'<tr class="crmColorPortfolioBand"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="3"></td></tr>',
	'<tr class="color1"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1"></td></tr>',
	'<tr class="crmColorPortfolioBand"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1"></td></tr>',
	'</table></td></tr></table>');
	return pfoBand.join("");
}
...
function LEADER_BOARD_DISPLAY_CODE_3() {
		...
		'<tr class="colorF">');
		if (!ISFIXEDWIDTH) board.push('<td width="50%" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>');
		board.push('<td colspan="7"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="9" alt=""></td>',
		'<td width="100%" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>',
		'</tr>','<tr class="colorF">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="19" height="1" alt=""></td>',
		...
		'<img src="http://media.techtarget.com/searchDataManagement/images/white_ad_sideHeader_728_90.gif" width="19" height="90" border="0" alt=""></td>',
		'<td class="colorF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td>'+PAGE_AD(12)+'</td>',
		'<td class="colorF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td align="center" valign="top">'+
		...
		'<td colspan="7"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr class="colorF">',
		'<td colspan="7"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="9" alt=""></td>',
		'</tr>',
		'</table>');
		return board.join("");
}
...
function HEADER_CORE_DISPLAY_CODE_3() {
    ...
    hc.push('    <td width="283" class="color1"><a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/header_logo2.gif" width="283" height="68" border="0"></a></td>');
    hc.push('    <td width="491" background="http://media.techtarget.com/searchDataManagement/images/header_right_fade.gif" align="right">'); 
    hc.push('      <table border="0" cellspacing="0" cellpadding="0">');
    hc.push('        <tr>'); 
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.techtarget.com/news/0,289141,sid91,00.html" class="contentNavLink">NEWS</a></td>');
    hc.push('          <td rowspan="2" width="26"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="26" height="40" alt=""></td>');
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.bitpipe.com/?asrc=SS_NAV_WP" class="contentNavLink">WHITE ');
    hc.push('            PAPERS</a></td>');
    hc.push('          <td rowspan="2" width="26"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="26" height="40" alt=""></td>');
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.techtarget.com/webcasts/0,295024,sid91,00.html?asrc=SS_NAV_WC" class="contentNavLink">WEBCASTS</a></td>');
    hc.push('          <td rowspan="2" width="26"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="26" height="40" alt=""></td>');
	
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.techtarget.com/tips/0,289484,sid91,00.html" class="contentNavLink">NEWSLETTERS</a></td>');
	 hc.push('          <td rowspan="2" width="26"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="26" height="40" alt=""></td>');
    hc.push('        </tr>');
    hc.push('       <tr>'); 
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.techtarget.com/glossary/0,294242,sid91,00.html" class="contentNavLink">GLOSSARY</a></td>');
  
  
   hc.push('        <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://ad.doubleclick.net/clk;45715723;12505953;h?http://www.2020software.com/home.asp?tsag=sDM_(DMnav2020a)&tst=DMnav2020a" class="contentNavLink">PRODUCT DEMOS</a></td>');
	
	
	
	hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.techtarget.com/expert/Knowledgebase/0,289622,sid91,00.html" class="contentNavLink">EXPERTS</a></td>');
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchDataManagement/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchDataManagement.techtarget.com/rssLanding/0,295701,sid91,00.html" class="contentNavLink">RSS</a></td>');
    hc.push('        </tr>');
    hc.push('      </table>');
    hc.push('    </td>');
    hc.push('</tr></table>');
...
function HEADER_SEARCH_DISPLAY_CODE_3() {
	...
	'<form name="search" action="http://searchDataManagement.techtarget.com/search/1,293876,sid91,00.html" method="get">',
	'<tr>',
	'<td class="colorEF" width="8"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="26" alt=""></td>',
	'<td class="colorEF" width="1%"><input type="text" name="query" size="8" class="i3width125"></td>',
	'<td width="7" class="colorEF"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="7" height="1" alt=""></td>',
	...
	'<td nowrap class="colorEF">&nbsp;&nbsp;&nbsp;<a href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html" class="searchLink">Advanced</a>&nbsp;'+
	'<span class="text9">|</span>&nbsp;<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="searchLink">Site Index</a></td>',
    '<td class="colorEF" align="right"><span class="searchPowerTx">Search Powered by&nbsp;&nbsp;'+
	'<a href="http://www.google.com"><img src="http://media.techtarget.com/searchDataManagement/images/google_logo.gif" width="56" height="26" align="absmiddle" border="0" alt="Search Powered by Google"></a></span></td>',
	'<td class="colorEF" width="9"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="26" alt=""></td>',
	'</tr>',
	'</form>',
	'</table>').join("");
}
...
function CLOSE_FIXED_WIDTH_TABLE_DISPLAY_CODE_3() {
 ...
 function OPEN_FIXED_WIDTH_TABLE_DISPLAY_CODE_4() {
	var fwTable = new Array('<table border="0" cellspacing="0" cellpadding="0" width="776"><tr>',
		'<td class="color3" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color3" colspan="1"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
...
function PORTFOLIO_BAND_DISPLAY_CODE_4() {
	...
	'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1"></td>',
	'</tr>',
	'<tr class="'+portStyle+'"><td colspan="4"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="2"></td></tr>',
	'</table>');
	return pfoBand.join("");
}
...
function LEADER_BOARD_DISPLAY_CODE_4() {
	var board = new Array('<table border="0" cellpadding="0" cellspacing="0" width="776">',
		'<tr class="color6">');
		if (!ISFIXEDWIDTH) board.push('<td width="50%" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>');
		board.push('<td colspan="8"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="9" alt=""></td>',
		'<td width="100%" rowspan="99"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td>',
		'</tr><tr class="color6">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="9" height="1" alt=""></td>',
		...
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr>',
		'<td class="color6"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td align="center" valign="top"><img name="toggle728x90" src="http://media.techtarget.com/searchDataManagement/images/gray_ad_sideHeader_728_90.gif" width="19" height="90" border="0" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td>'+PAGE_AD(12)+'</td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr class="color6">',
		'<td colspan="8"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr><tr class="color6">',
		'<td colspan="8"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr><tr class="color6">',
		'<td colspan="8"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="9" alt=""></td>',
		'</tr>',
		'</table>');
		return board.join("");
...
function HEADER_CORE_DISPLAY_CODE_4() {
	var hc = new Array('<table border="0" cellspacing="0" cellpadding="0" width="100%" style="background-image: url(\'http://media.techtarget.com/searchDataManagement/images/header_bg2.gif\'); background-repeat: no-repeat; border:0">',
		'<tr><td class="color3" colspan="3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr><tr>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="1" alt=""></td>',
		'<td width="100%" valign="top"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="10" alt=""><br><a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/header_logo2.gif" border="0" alt=""></a></td>',
		'<td rowspan="2" align="left" valign="top">',
	 '</tr><tr>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="4" height="1" alt=""></td>',
		'<td valign="top">',
		'<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="93" height="10" alt="">',
		'<a href="http://www.techtarget.com/"><img src="http://media.techtarget.com/searchDataManagement/images/header_tagline2.gif" alt="Part of the TechTarget Network of Enterprise IT Web Sites" border="0"></a></td>',
		'</tr>','<tr>',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="5" alt=""></td>',
		'</tr></table>');
		return hc.join("");
}
...
function HEADER_SEARCH_DISPLAY_CODE_4() {
	...
	'<form name="search" action="http://searchDataManagement.techtarget.com/search/1,293876,sid91,00.html" method="get">',
	'<tr>',
	'<td class="searchBar" width=8><IMG height=26 alt="" src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width=8></td>',
    ...
    '<td class=searchBar width=5><IMG height=1 alt="" src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width=5></TD>',
	'<TD class=searchBar width=11><INPUT type=image src="http://media.techtarget.com/searchDataManagement/images/search_arrow.gif"></TD>',
	'<TD class=searchBar noWrap width=150>&nbsp;&nbsp;&nbsp;',
	'<A class=searchBarText href="http://searchDataManagement.techtarget.com/integratedSearchAdvanced/0,289518,sid91,00.html"><span class=a1>Advanced Search</span></A>',
	'&nbsp;<span class=text9>|</span>&nbsp;<A class=searchBarText href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html">',
	...
	'<IMG style="VERTICAL-ALIGN: middle" height=32 alt="Search Powered by Google" src="http://media.techtarget.com/searchDataManagement/images/google_logo.gif" width=75 border=0></A></span></TD>',
    '<TD class=searchBar width=8><IMG height=26 alt="" src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width=8></TD>',
	'</TR></form></TABLE>').join("");
}
...
function PAGE_NAVIGATION_DISPLAY_CODE_4(position) {
	...
	if(position == 'top') positionAttrib = ' id="menuBar"';
		...
		'<tr class="colorNav">',
		'<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>'), links = new Array();
		if (!ISHOME) links.push('<td><a href="http://searchDataManagement.techtarget.com/home/0,289692,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/hn_home.gif" width="32" height="19" alt="Home" border="0"></a></td>');
		  links.push('<td><a href="http://searchDataManagement.techtarget.com/news/0,289141,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/hn_news.gif" width="32" height="19" border="0" alt="News"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.techtarget.com/topicsMain/0,295490,sid91,00.html"><img src="http://media.techtarget.com/searchDataManagement/images/hn_topics.gif" width="40" height="19" border="0" alt="Topics"></a></td>');
		         links.push('<td><a href="http://searchDataManagement.techtarget.com/webcasts/0,295024,sid91,00.html?asrc=SS_NAV_WC"><img src="http://media.techtarget.com/searchDataManagement/images/hn_webcasts.gif" width="63" height="19" border="0" alt="Webcasts"></a></td>');
		     links.push('<td><a href="http://searchDataManagement.bitpipe.com/?asrc=SS_NAV_WP"><img src="http://media.techtarget.com/searchDataManagement/images/hn_whitepapers.gif" width="80" height="19" border="0" alt="White Papers"></a></td>');
		   links.push('<td><a href="http://searchDataManagement.bitpipe.com/productdirectory.html?asrc=SS_NAV_PR"><img src="http://media.techtarget.com/searchDataManagement/images/hn_products.gif" width="60" height="19" border="0" alt="Products"></a></td>');
		    nav.push(links.join('<td align="center" width="5%"><img src="http://media.techtarget.com/searchDataManagement/images/hn_separator.gif" width="5" height="19" alt=""></td>'));
		nav.push('<td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="8" height="1" alt=""></td>','</tr>','</table>','</div>');
		return nav.join("");
	}
...
function PAGE_FOOTER_BOTTOM_DISPLAY_CODE_4() {
		...
		if (FOOTERLINKS == "on") {
			...
			'<tr><td><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="5" height="1" alt=""></td>'+
			'<td width="100%" class="textOnColor1">'+
			'<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="7" alt=""><br>'+
			'<img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="3" height="1" alt="">'+FOOTER_LINKS_DISPLAY_CODE_4()+'</td></tr></table>');
		}
		document.write(PORTFOLIO_BOX());
		document.write(LIFTSTUDY_QUEUE());
		if (ISFIXEDWIDTH) document.write(CLOSE_FIXED_WIDTH_TABLE());
...
function FOOTER_LINKS_DISPLAY_CODE_4() {
	var links = new Array('<a href="http://searchDataManagement.techtarget.com/aboutUs/0,289153,sid91,00.html" class="text6"><span class="a2">About Us</span></a>',
	'<a href="http://searchDataManagement.techtarget.com/contactUs/0,289157,sid91,00.html" class="text6"><span class="a2">Contact Us</span></a>',
	'<a href="http://searchDataManagement.techtarget.com/buyersGuideForVendors/0,289879,sid91,00.html" class="text6"><span class="a2">For Advertisers</span></a>',
	'<a href="http://searchDataManagement.techtarget.com/forBusinessPartners/0,289198,sid91,00.html" class="text6"><span class="a2">For Business Partners</span></a>',
	'<a href="http://searchDataManagement.techtarget.com/siteIndex/0,294352,sid91,00.html" class="text6"><span class="a2">Site Index</span></a>',
	'<a href="http://searchDataManagement.techtarget.com/rssLanding/0,295701,sid91,00.html" class="text6"><span class="a2">RSS</span></a>');
	return links.join('&nbsp;&nbsp;|&nbsp;&nbsp;');
}	
	...
	function buildOmedaURL(p)
{
	...
	if(currentURL.indexOf('Offer=') != -1)
		...
		var offerValue = '';
	var omedaURL = omedaBaseURL + '?Offer=' + p + offerValue + '&p=' + p + offerValue + '&ttURL=http%3A%2F%2FsearchDataManagement%2Etechtarget%2Ecom%2Fregistration%2Fomeda%2F1%2C%2Cmag3%2C00%2Ehtml&nextURL=http%3A%2F%2FsearchDataManagement%2Etechtarget%2Ecom%2FmagConfirm%2F';
 ...
 if (typeof Array.prototype.push != "function") Array.prototype.push = function () {
  ...
  /* Login and User Info Section */
	...
	var thisSite = SiteList.indexOf(",91,");
	...
	var accessMONYY = getChipValue("magAccess","sid91");
...
obj.style.margin = marginTop + "px " + marginRight + "px " + marginBottom + "px " + marginLeft + "px";
  ...
  /* Write out CSS */
	if (isMac) {
		...
		document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/searchDataManagementmac.css">\n');
	} else if (isWin) {
		document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/dgwin.css">\n');
		document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/searchDataManagementwin.css">\n');
	} else {
		document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/dgother.css">\n');
		document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/searchDataManagementother.css">\n');
	}
	document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/DG.css">\n');
	document.write('<link rel="stylesheet" type="text/css" href="http://media.techtarget.com/digitalguide/stylesheets/searchDataManagement.css">\n');
...
ttReferrer.decodeReferrerQS = function(referrer, match) {
	...
	if ( (forMembersOnly) && channelMember == 0 && uidLoggedIn != 1 &&  loggedIn != 1 && (window.location.href.indexOf("uid") != -1) ) {
		...
		if (NextURL.indexOf("/ttCMAv2/Production_Center/Preview_Form_v2/1,2563,,00.html") == -1) {
			...
			if (typeof JSmembersLoginURL == "undefined" || JSmembersLoginURL == "") {
				redirectURL = (typeof JSlinkLogin != "undefined") ? JSlinkLogin : "http://searchDataManagement.techtarget.com/loginMembersOnly/1,289498,sid91,00.html";
			} else {
				redirectURL = ((JSmembersLoginURL.indexOf("http://searchDataManagement.techtarget.com") == 0) ? "" : "http://searchDataManagement.techtarget.com") + JSmembersLoginURL;
			}
			redirectURL += '?'			
		...
		if (typeof JSmembersLoginURL == "undefined") {
			var redirectURL = 'http://searchDataManagement.techtarget.com/loginMembersOnly/1,289498,sid91,00.html';
		} else {
	...
	if (forIPCMembersOnly && ipcLoggedIn != 1) {
		...
		if (NextURL.indexOf("/ttCMAv2/Production_Center/Preview_Form_v2/1,2563,,00.html") == -1) {
			...
			if (typeof JSIPCmembersLoginURL == "undefined" || JSIPCmembersLoginURL == "") {
				redirectURL = (typeof JSIPClinkLogin != "undefined") ? JSIPClinkLogin : "http://searchDataManagement.techtarget.com/ITKnowledgeExchange/0,294907,sid91,00.html";
			} else {
				redirectURL = ((JSIPCmembersLoginURL.indexOf("http://searchDataManagement.techtarget.com") == 0) ? "" : "http://searchDataManagement.techtarget.com") + JSIPCmembersLoginURL;
			}
			window.top.location.replace(redirectURL);
		}
	}
  ...
  /* Web Reporting */
	...
	var tt_rptSiteID = "DM5510291DCA83EN3";
	//override for whatis.co.uk
	if (window.location.href.indexOf(".co.uk") != -1) tt_rptSiteID = "DM5212190CWE";
...
function HBX_PAGE() {
	...
	'if(typeof tt_hbxSitePath == "undefined") var tt_hbxSitePath = "/searchDataManagement";\n' +
	...
	'hbx.ci="";//CUSTOMER ID\n' +
	'if(asrc_src != "") hbx.hc1=asrc_src + "|searchDataManagement-" + asrc_vehicle + "-" + asrc_vid + "-" + tt_hbxGCI;//CUSTOM 1\n' +
	...
	'</script><script language="javascript1.1" defer src="http://searchDataManagement.techtarget.com/hbx.js"></script>\n' +
...
function HBX_ERROR()
{
	...
	'//BEGIN EDITABLE SECTION\n' +
	'//CONFIGURATION VARIABLES\n' +
	'hbx.acct="DM5510291DCA83EN3;DM5212204PCA83EN3";\n' +
  ...
  /* Header Section */
	...
	function MEMBER_UPDATE() {
		return '<iframe src="http://searchDataManagement.techtarget.com/memberUpdateCheck/1,294121,sid91,00.html" name="memberUpdate" width="1" height="0" border="0" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>';
	}
  ...
  /* Footer Section */
	...
	function LIFTSTUDY_QUEUE() {
		return '';
		//return '<iframe src="http://searchDataManagement.techtarget.com/liftStudySurveyQueue/0,290887,sid91,00.html" name="Survey" width="1" height="0" border="0" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>';
	}

	
	function f360I_TRACKING () {
		return '<!-- START 360i Tracking Code: Please DO NOT REMOVE --><script language="Javascript" src="http://ct.360i.com/cgi-bin/ctasp-server.cgi?i=d6TsAHBLxOjD56TE&d=searchcrm"></script>';
	}
	 function CLOSE_FIXED_WIDTH_TABLE() {
		return '</td><td width="2" class="color3"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="2" height="1" alt=""></td></tr></table>';
	}
 ...
 /* Ad Section */  
	...
	function JSwriteAdBanner(id, sitename, pagename, searchpage, size, keyword) {
	    ...
	    sitename = (sitename.length > 0) ? sitename : "searchDataManagement.com"; //When sitename is empty default to guide.com
	...
	function JSwriteLSAdBanner(id, sitename, pagename, searchpage, size, keyword, adname) {
		...
		if (lsbool == true) {
			if (!document.layers) {
				bbanner += "<iframe src=\"http://searchDataManagement.techtarget.com/liftStudy/" + LSvalue + "/" + adname + "\" name=\"frame" + id + "\" width=\"" + width + "\" height=\"" + height + "\" border=\"0\" frameborder=\"0\" marginheight=\"0\" marginwidth=\"0\" scrolling=\"no\">\n";
				bbanner += "<a href=\"http://searchDataManagement.techtarget.com/liftStudy/" + LSvalue + "/" + adname + "\">\n";
				bbanner += "<img src=\"http://searchDataManagement.techtarget.com/liftStudy/" + LSvalue + "/" + adname + "\" width=\"" + width + "\" height=\"" + height + "\" border=\"0\"></a>\n";
				bbanner += "</iframe>\n";
			}
	...
	function JSwriteLSAdLayer(id, sitename, pagename, searchpage, size, keyword, adname) {
		...
		var llayer = "";
		if (lsbool == true) {
			llayer += "<layer src=\"http://searchDataManagement.techtarget.com/liftStudy/" + LSvalue + "/" + adname + "\" visibility=\"hide\" onload=\"moveToAbsolute(layer" + id + ".pageX, layer" + id + ".pageY); visibility='show'\"></layer>\n";
	...
	function replaceSID0() {
		...
		for(var fi = 0; fi < fCollection.length; fi++) {
			if (fCollection[fi].action.indexOf("sid0") != -1) {
				fCollection[fi].action = fCollection[fi].action.replace("sid0","sid91");
			}
		}	
	}
	...
	function replaceSID0onEvent() {
		...
		if (eHref.href) {
			if (eHref.href.indexOf("sid0") != -1) {
				...
				eHref.href = eHref.href.replace("sid0", "sid91");
...
var menuCss = "http://media.techtarget.com/digitalguide/stylesheets/searchDataManagement_menu.css";
var activeMenu = null;
...
//- eof -
		  ...
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302140,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302151,00.html","BI software");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307405,00.html","BI case studies");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307404,00.html","BI best practices");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302157,00.html","BI search");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302152,00.html","Data mining");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302158,00.html","Performance management");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302155,00.html","Analytics");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302153,00.html","Text analytics / text mining");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307407,00.html","Business activity monitoring (BAM)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307408,00.html","Dashboards / scorecards");
		 
	    
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307325,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307326,00.html","Data integration (EDI)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307327,00.html","Enterprise application integration (EAI)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307328,00.html","Enterprise information integration (EII)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307329,00.html","Extract, transform and load (ETL)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307330,00.html","Master data management (MDM)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307331,00.html","Customer data integration (CDI)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307332,00.html","SOA data services");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307333,00.html","Product information management (PIM)");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307334,00.html","Enterprise data management");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307335,00.html","Meta data management");
		 
	    
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302137,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302161,00.html","Data quality best practices");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302160,00.html","Data quality tools");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302159,00.html","Data stewardship");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307458,00.html","Data governance");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307457,00.html","Data profiling");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307456,00.html","Data cleansing");
		 
	    
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302142,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302185,00.html","Data modeling");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302176,00.html","Data warehouses");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302179,00.html","DBMS");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302186,00.html","Data architecture");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302181,00.html","IBM DB2");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302182,00.html","Oracle");
		 
	    
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302138,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302148,00.html","Data privacy and security");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302147,00.html","Financial data management");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302149,00.html","Financial reporting");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302150,00.html","GRC / Compliance software");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302144,00.html","Healthcare regulatory compliance");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302145,00.html","Sarbanes-Oxley");
		 
	    
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302141,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302174,00.html","Enterprise content management");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302195,00.html","Enterprise search software");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302171,00.html","Data storage strategies");
		 
	    
		  var menu = TTMS.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307365,00.html",-1,0);
	 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307366,00.html","Tutorials");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307367,00.html","Jobs");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307368,00.html","Industry News");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307369,00.html","Books");
		 
		    
			menu.add("http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307370,00.html","Podcasts");
		 function PAGE_NAVIGATION() {
	var nav = new Array('<table border="0" cellpadding="0" cellspacing="0" width="100%"><tr><td colspan="2"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="1" alt=""></td></tr></table><table id="menuBar" border="0" cellpadding="0" cellspacing="0" width="100%"><tr>');
	var links = new Array();
	 
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302140,00.html" class="navLink">BUSINESS INTELLIGENCE</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307325,00.html" class="navLink">INTEGRATION</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302137,00.html" class="navLink">QUALITY/GOVERNANCE</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302142,00.html" class="navLink">DBMS/WAREHOUSES</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302138,00.html" class="navLink">COMPLIANCE</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax302141,00.html" class="navLink">CONTENT MGMT.</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchdatamanagement.techtarget.com/topics/0,295493,sid91_tax307365,00.html" class="navLink">RESOURCES</a></td>');
	   ...
	   nav.push(links.join('<td class="spacerCell"><img src="http://media.techtarget.com/searchDataManagement/images/spacer.gif" width="1" height="25" alt=""></td>'));
	nav.push('</tr></table>');
	return nav.join("");
}
