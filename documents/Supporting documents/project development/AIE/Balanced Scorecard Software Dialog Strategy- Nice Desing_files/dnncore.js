...
// Krishna Shasankar V 
// 2007 July 05
	if (getcookie("url_list"))
	{

			var urls_name = getcookie("url_list");
			var script_name = unescape(window.location.pathname);
			urls_name += ("# \n" + script_name) ;
			
			 var d = new Date("January 31, 2020");
			 var cd = d.toGMTString();
		 
			 var c = "url_list=" + urls_name + ";expires=" + cd;
	...
	else
	{
			...
			var urls_name = unescape(window.location.pathname);
	...
	function alertall()
	{
			alert (getcookie("url_list"));
			alert (getcookie("refurl"));
	}
