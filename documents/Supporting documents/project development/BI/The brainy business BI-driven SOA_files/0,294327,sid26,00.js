...
var SID = 26;
	function HEADER_CHANNEL() {
		...
		document.write('<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="9" height="43" alt=""></td>');
		document.write('<td width="100%" valign="top"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="10" alt=""><br>');
		...
		document.write('</tr>');
		document.write('<tr class="colorHeader">');
		document.write('<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="16" border="0" alt=""></td>');
		document.write('<td valign="top"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="59" height="1" alt=""><a href="http://www.techtarget.com"><img src="http://media.techtarget.com/searchWebServices/images/header_tagline.gif" alt="Part of the IT Channel TechTarget Sites" border="0"></a></td>');
		document.write('</tr>');
	...
	function HEADER_SEARCH_CHANNEL() {
		...
		'<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="text6"><span class="a1">SITE INDEX</span></a></td>',
	...
	function HEADER_SEARCH_DISPLAY_CODE_0() {
		...
		'<span class="textF"><span class="a2">|</span></span>&nbsp;&nbsp;',
		'<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="textF"><span class="a1">SITE INDEX</span></a></td>',
		'<td width="100%"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
 ...
 function PAGE_FOOTER_TOP_DISPLAY_CODE_0 () {}
	...
	function PAGE_FOOTER_BOTTOM_DISPLAY_CODE_0() {
	 ...
	 function FOOTER_LINKS_DISPLAY_CODE_0() {
		...
		'<a href="http://searchWebServices.techtarget.com/forBusinessPartners/0,289198,sid26,00.html" class="textOnColor1">For Business Partners</a>',
			...
			'<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="textOnColor1">Site Index</a>',
	...
	function PORTFOLIO_BOX_DISPLAY_CODE_0() {
		...
		var box = new Array('<style type="text/css">',
							...
							'<tr>',
							'<td style="font: normal 11px arial">TechTarget provides enterprise IT professionals with the information they need to perform their jobs - from developing strategy, to making cost-effective IT purchase decisions and managing their organizations IT projects - with its network of <a href="javascript:portfolioWindow(\'http://searchwebservices.techtarget.com/portfolioSites/0,296825,sid26,00.html\')" class="footerLink">technology-specific Web sites, events and magazines</a>.</td>',
							'</tr>',
							'</table>',
							...
							links.push('<a href="http://www.techtarget.com/" class="footerLink">TechTarget Corporate Web Site</a>',
										...
										'<a href="http://searchWebServices.techtarget.com/reprints/0,296569,sid26,00.html" class="footerLink">Reprints</a>');
							 links.push('<a href="http://searchWebServices.techtarget.com/sitemap/0,296817,sid26,00.html" class="footerLink">Site Map</a>');
							box = box.concat(links.join('&nbsp;&nbsp;|&nbsp;&nbsp;'));							
							box.push('<br><br><br><br><br>All Rights Reserved, <a href="http://searchWebServices.techtarget.com/copyright/0,289135,sid26,00.html" class="footerLink">Copyright 2001 - 2007</a>, TechTarget&nbsp;|&nbsp;<a href="http://www.techtarget.com/html/privacy_policy.html" class="footerLink" target=_>Read our Privacy Policy</a>',
							'</td>',
							'<td width="100%">&nbsp;</td>',
...
function PORTFOLIO_BAND_DISPLAY_CODE_1() {
	...
	'<td nowrap align="right"><span class="textOnColorPortfolioBand">'+((USERINFO == "on") ? '<span class="textOnColorPortfolioBand">'+((loggedIn != -1) ? '<span class="h2"><i>You\'re logged in as:</i> '+DisplayName+'</span>&nbsp;'+
			...
			'<a href="'+((ALTLOGOUT != "no") ? ALTLOGOUT : 'http://searchWebServices.techtarget.com/logout/1,289500,sid26,00.html')+'" class="textOnColorPortfolioBand2"><span class="h2">Log-out</span></a>' :
			...
			'<a href="'+((ALTLOGIN != "no") ? ALTLOGIN : 'http://searchWebServices.techtarget.com/login/1,289498,sid26,00.html')+'" class="textOnColorPortfolioBand2"><span class="h2">Log-in</span></a>')+'</span></span>' : '&nbsp;')+
	'</span></td>',
	'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="3" height="1" alt=""></td>',
...
'<td valign="middle">');
	...
	core.push('</td>',
	'<td rowspan="99" class="'+mediaClass+'"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>',
...
function COLOR1_LINE_DISPLAY_CODE_1 () {
	...
	'<tr class="color1">',
	'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="3" border="0" alt=""></td>',
	'</tr></table>');
...
function SEARCHBOX_DISPLAY_CODE_1(position) {
	...
	'<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="searchbarLink">SITE INDEX</a>',
	'</td>',
	'<td width="100%"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
...
function SEARCHBOX_CLICKTHRU_DISPLAY_CODE_1(position) {
	searchbox = new Array('<!-- BEGIN: search bar -->',
			...
			'</td>',
			'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="8" height="1" alt=""></td>',
			'<td nowrap><a href="http://searchWebServices.techtarget.com/integratedSearchAdvanced/0,289518,sid26,00.html" class="searchbarLink">ADVANCED SEARCH</a>&nbsp;&nbsp;<span class="textF"><span class="h2">|</span></span>&nbsp;&nbsp;<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="searchbarLink">SITE INDEX</a></td>',
...
function PORTFOLIO_BOX_DISPLAY_CODE_1() {
	...
	'<table border="0" cellpadding="0" cellspacing="0" width="100%">',
	'<tr>',
	'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="10" height="40" alt=""></td>',
	'<td width="100%" style="font: normal 11px tahoma">TechTarget provides enterprise IT professionals with the information they need to perform their jobs - from developing strategy, to making cost-effective IT purchase decisions and managing their organizations\' IT projects - with its <a href="javascript:portfolioWindow(\'http://searchwebservices.techtarget.com/portfolioSites/0,296825,sid26,00.html\')" class="footerLink">network of technology-specific Web sites, events and magazines.</a></td>',
	'<td class="color1"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>',
	'<table border="0" cellspacing="0" cellpadding="0" width="100%">',
	'<tr class="colorFooter">',
	'<td rowspan="3"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="10" height="1" alt=""></td>',
	'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="634" height="20" alt=""></td>',
	...
	links = new Array();
	links.push('<a href="http://searchWebServices.techtarget.com/buyersGuideForVendors/0,289879,sid26,00.html" class="footerLink">For Advertisers</a>',
				'<a href="http://www.techtarget.com/mediakit/" class="footerLink">Media Kit</a>',
				'<a href="/ciodCalendar/0,296143,sid26,00.html" class="footerLink">Editorial Calendar</a>',
				'<a href="http://searchWebServices.techtarget.com/sitemap/0,296817,sid26,00.html" class="footerLink">Site Map</a>',
	...
	'<tr class="color3">',
	'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="4" height="19" alt=""></td>',
	'<td width="100%"><span class="h2"><span class="textF">All Rights Reserved, <a href="http://searchWebServices.techtarget.com/copyright/0,289135,sid26,00.html" class="footerLink2"><span class="h2">Copyright 2001 - 2007</span></a>, TechTarget</span></span></td>',
	...
	'<td align="right"><a href="http://www.techtarget.com/html/privacy_policy.html" target="_blank" class="footerLink2"><span class="h2">Read our Privacy Policy</span></a><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="8" height="1" alt=""></td>',
	'</tr>',
	'</table>');
	return box.join("");
}
...
function HEADER_CORE_DISPLAY_CODE_3() {
    ...
    hc.push('          <td nowrap><img src="http://media.techtarget.com/searchWebServices/images/arrow_content_item.gif" width="5" height="5" align="absmiddle"><a href="http://searchWebServices.techtarget.com/tips/0,289484,sid26,00.html" class="contentNavLink">NEWSLETTERS</a></td>');
	 hc.push('          <td rowspan="2" width="26"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="26" height="40" alt=""></td>');
    hc.push('        </tr>');
    hc.push('       <tr>'); 
...
function HEADER_SEARCH_DISPLAY_CODE_3() {
	...
	'<span class="text9">|</span>&nbsp;<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="searchLink">Site Index</a></td>',
...
function CLOSE_FIXED_WIDTH_TABLE_DISPLAY_CODE_3() {
 ...
 function OPEN_FIXED_WIDTH_TABLE_DISPLAY_CODE_4() {
	var fwTable = new Array('<table border="0" cellspacing="0" cellpadding="0" width="776"><tr>',
		'<td class="color3" rowspan="99"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color3" colspan="1"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
...
function PORTFOLIO_BAND_DISPLAY_CODE_4() {
	...
	'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="5" height="1"></td>',
	'</tr>',
	'<tr class="'+portStyle+'"><td colspan="4"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="2"></td></tr>',
	'</table>');
	return pfoBand.join("");
}
...
function LEADER_BOARD_DISPLAY_CODE_4() {
	var board = new Array('<table border="0" cellpadding="0" cellspacing="0" width="776">',
		'<tr class="color6">');
		if (!ISFIXEDWIDTH) board.push('<td width="50%" rowspan="99"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="2" height="1" alt=""></td>');
		board.push('<td colspan="8"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="9" alt=""></td>',
		'<td width="100%" rowspan="99"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="2" height="1" alt=""></td>',
		'</tr><tr class="color6">',
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="9" height="1" alt=""></td>',
		...
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr>',
		'<td class="color6"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td align="center" valign="top"><img name="toggle728x90" src="http://media.techtarget.com/searchWebServices/images/gray_ad_sideHeader_728_90.gif" width="19" height="90" border="0" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td>'+PAGE_AD(12)+'</td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'<td class="color6"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr>','<tr class="color6">',
		'<td colspan="8"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr><tr class="color6">',
		'<td colspan="8"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr><tr class="color6">',
		'<td colspan="8"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="9" alt=""></td>',
		'</tr>',
		'</table>');
		return board.join("");
...
function HEADER_CORE_DISPLAY_CODE_4() {
	var hc = new Array('<table border="0" cellspacing="0" cellpadding="0" width="100%" style="background-image: url(\'http://media.techtarget.com/searchWebServices/images/header_bg2.gif\'); background-repeat: no-repeat; border:0">',
		'<tr><td class="color3" colspan="3"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="1" alt=""></td>',
		'</tr><tr>',
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="4" height="1" alt=""></td>',
		'<td width="100%" valign="top"><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="10" alt=""><br><a href="http://searchWebServices.techtarget.com/home/0,289692,sid26,00.html"><img src="http://media.techtarget.com/searchWebServices/images/header_logo2.gif" border="0" alt=""></a></td>',
		'<td rowspan="2" align="left" valign="top">',
	 '</tr><tr>',
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="4" height="1" alt=""></td>',
		'<td valign="top">',
		'<img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="93" height="10" alt="">',
		'<a href="http://www.techtarget.com/"><img src="http://media.techtarget.com/searchWebServices/images/header_tagline2.gif" alt="Part of the TechTarget Network of Enterprise IT Web Sites" border="0"></a></td>',
		'</tr>','<tr>',
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="5" alt=""></td>',
		'</tr></table>');
		return hc.join("");
}
...
function HEADER_SEARCH_DISPLAY_CODE_4() {
	...
	'<form name="search" action="http://searchWebServices.techtarget.com/search/1,293876,sid26,00.html" method="get">',
	'<tr>',
	'<td class="searchBar" width=8><IMG height=26 alt="" src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width=8></td>',
    ...
    '<td class=searchBar width=5><IMG height=1 alt="" src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width=5></TD>',
	'<TD class=searchBar width=11><INPUT type=image src="http://media.techtarget.com/searchWebServices/images/search_arrow.gif"></TD>',
	'<TD class=searchBar noWrap width=150>&nbsp;&nbsp;&nbsp;',
	'<A class=searchBarText href="http://searchWebServices.techtarget.com/integratedSearchAdvanced/0,289518,sid26,00.html"><span class=a1>Advanced Search</span></A>',
	'&nbsp;<span class=text9>|</span>&nbsp;<A class=searchBarText href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html">',
	...
	'<IMG style="VERTICAL-ALIGN: middle" height=32 alt="Search Powered by Google" src="http://media.techtarget.com/searchWebServices/images/google_logo.gif" width=75 border=0></A></span></TD>',
    '<TD class=searchBar width=8><IMG height=26 alt="" src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width=8></TD>',
	'</TR></form></TABLE>').join("");
}
...
function PAGE_NAVIGATION_DISPLAY_CODE_4(position) {
	...
	if(position == 'top') positionAttrib = ' id="menuBar"';
		...
		'<tr class="colorNav">',
		'<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="8" height="1" alt=""></td>'), links = new Array();
		if (!ISHOME) links.push('<td><a href="http://searchWebServices.techtarget.com/home/0,289692,sid26,00.html"><img src="http://media.techtarget.com/searchWebServices/images/hn_home.gif" width="32" height="19" alt="Home" border="0"></a></td>');
		  links.push('<td><a href="http://searchWebServices.techtarget.com/news/0,289141,sid26,00.html"><img src="http://media.techtarget.com/searchWebServices/images/hn_news.gif" width="32" height="19" border="0" alt="News"></a></td>');
		   links.push('<td><a href="http://searchWebServices.techtarget.com/topicsMain/0,295490,sid26,00.html"><img src="http://media.techtarget.com/searchWebServices/images/hn_topics.gif" width="40" height="19" border="0" alt="Topics"></a></td>');
		         links.push('<td><a href="http://searchWebServices.techtarget.com/webcasts/0,295024,sid26,00.html?asrc=SS_NAV_WC"><img src="http://media.techtarget.com/searchWebServices/images/hn_webcasts.gif" width="63" height="19" border="0" alt="Webcasts"></a></td>');
		     links.push('<td><a href="http://searchWebServices.bitpipe.com/?asrc=SS_NAV_WP"><img src="http://media.techtarget.com/searchWebServices/images/hn_whitepapers.gif" width="80" height="19" border="0" alt="White Papers"></a></td>');
		   links.push('<td><a href="http://searchWebServices.bitpipe.com/productdirectory.html?asrc=SS_NAV_PR"><img src="http://media.techtarget.com/searchWebServices/images/hn_products.gif" width="60" height="19" border="0" alt="Products"></a></td>');
		    nav.push(links.join('<td align="center" width="5%"><img src="http://media.techtarget.com/searchWebServices/images/hn_separator.gif" width="5" height="19" alt=""></td>'));
		nav.push('<td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="8" height="1" alt=""></td>','</tr>','</table>','</div>');
		return nav.join("");
	}
...
function PAGE_FOOTER_BOTTOM_DISPLAY_CODE_4() {
		...
		if (FOOTERLINKS == "on") {
			...
			'<tr><td><img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="5" height="1" alt=""></td>'+
			'<td width="100%" class="textOnColor1">'+
			'<img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="1" height="7" alt=""><br>'+
			'<img src="http://media.techtarget.com/searchWebServices/images/spacer.gif" width="3" height="1" alt="">'+FOOTER_LINKS_DISPLAY_CODE_4()+'</td></tr></table>');
		}
		document.write(PORTFOLIO_BOX());
		document.write(LIFTSTUDY_QUEUE());
		if (ISFIXEDWIDTH) document.write(CLOSE_FIXED_WIDTH_TABLE());
...
function FOOTER_LINKS_DISPLAY_CODE_4() {
	var links = new Array('<a href="http://searchWebServices.techtarget.com/aboutUs/0,289153,sid26,00.html" class="text6"><span class="a2">About Us</span></a>',
	'<a href="http://searchWebServices.techtarget.com/contactUs/0,289157,sid26,00.html" class="text6"><span class="a2">Contact Us</span></a>',
	'<a href="http://searchWebServices.techtarget.com/buyersGuideForVendors/0,289879,sid26,00.html" class="text6"><span class="a2">For Advertisers</span></a>',
	'<a href="http://searchWebServices.techtarget.com/forBusinessPartners/0,289198,sid26,00.html" class="text6"><span class="a2">For Business Partners</span></a>',
	'<a href="http://searchWebServices.techtarget.com/siteIndex/0,294352,sid26,00.html" class="text6"><span class="a2">Site Index</span></a>',
	'<a href="http://searchWebServices.techtarget.com/rssLanding/0,295701,sid26,00.html" class="text6"><span class="a2">RSS</span></a>');
	return links.join('&nbsp;&nbsp;|&nbsp;&nbsp;');
}	
...
ttReferrer.decodeReferrerQS = function(referrer, match) {
	...
	if ( (forMembersOnly) && channelMember == 0 && uidLoggedIn != 1 &&  loggedIn != 1 && (window.location.href.indexOf("uid") != -1) ) {
		...
		if (typeof JSmembersLoginURL == "undefined") {
			var redirectURL = 'http://searchWebServices.techtarget.com/loginMembersOnly/1,289498,sid26,00.html';
		} else {
...
//- eof -
		  ...
		  var menu = TTMS.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax299037,00.html",-1,0);
			...
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax299051,00.html","Service-oriented architecture (SOA) education");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305713,00.html","Service-oriented architecture (SOA) development");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305715,00.html","Governance and management");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax299050,00.html","Implementations");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305712,00.html","SOA orchestration");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305726,00.html","Data management and SOA");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax300618,00.html","Data center");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305718,00.html","SOA and XML networking");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax301935,00.html","SOA event-driven architecture (EDA)");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax300610,00.html","BPM");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305722,00.html","Security");
		 
	    
		  var menu = TTMS.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298931,00.html",-1,0);
	 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305741,00.html","Application servers and Web service platforms");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305748,00.html","Portals, presentation and clients");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax300608,00.html","Web services testing");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305753,00.html","Open source");
			...
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298952,00.html","LAMP Web services (Linux, Apache, MySQL & PHP)");
			...
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305761,00.html","Mobile Web services");
		 
	    
		  var menu = TTMS.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298809,00.html",-1,0);
	 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298902,00.html","XML and XML schema");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax301933,00.html","First generation Web services standards");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax301932,00.html","Web services security specifications");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298923,00.html","Web services transaction specifications");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax301937,00.html","SOA management standards");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax301934,00.html","Reliable message standards");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax301927,00.html","SOA orchestration and choreography");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305801,00.html","Emerging SOA standards");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305805,00.html","SOA standards bodies");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305810,00.html","Java standards");
		 
	    
		  var menu = TTMS.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298965,00.html",-1,0);
	 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298969,00.html","ESB");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298968,00.html","EAI");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305786,00.html","Mediation");
		 
		    
			menu.add("http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax305787,00.html","APIs");
	...
	var links = new Array();
		...
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298931,00.html" class="navLink">WEB SERVICES DEVELOPMENT</a></td>');
	  
	
		links.push('<td class="navCell" nowrap bgcolor="#000000"><a href="http://searchwebservices.techtarget.com/topics/0,295493,sid26_tax298809,00.html" class="navLink">SOA AND WEB SERVICES STANDARDS</a></td>');
