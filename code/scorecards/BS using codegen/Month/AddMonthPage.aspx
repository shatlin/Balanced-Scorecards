...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddMonthPage.aspx.cs" Inherits="BS.UI.AddMonthPage" %>
<%@ Register Tagprefix="BS" TagName="Pagination" Src="../Shared/Pagination.ascx" %>

<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.AddMonthPage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>AddMonthPage</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="pbTable">
            ...
            <tr>
                ...
                <asp:UpdateProgress runat="server" id="MonthRecordControlUpdateProgress" AssociatedUpdatePanelID="MonthRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="MonthDialogTitle" Text="Add Month">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
    ...
    <td class="dialog_field_value">
        <asp:TextBox runat="server" id="MonthName" Columns="50" MaxLength="50" CssClass="field_input" EnableIncrementDecrementButtons="True">
														</asp:TextBox>&nbsp;
