...
// This file implements the code-behind class for EditMonthPage.aspx.
// App_Code\EditMonthPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditMonthPage
        : BaseApplicationPage
// Code-behind class for the EditMonthPage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.MonthRecordControl.LoadData();
                    this.MonthRecordControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.MonthRecordControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.MonthRecordControl != null && this.MonthRecordControl.DataSource != null){
                id = this.MonthRecordControl.DataSource.MonthId.ToString();
                value = this.MonthRecordControl.DataSource.GetValue(this.MonthRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
