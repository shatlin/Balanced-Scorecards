...
// This file implements the code-behind class for ShowMonthTablePage.aspx.
// App_Code\ShowMonthTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class ShowMonthTablePage
        : BaseApplicationPage
// Code-behind class for the ShowMonthTablePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.MonthTableControl.LoadData();
                    this.MonthTableControl.DataBind();           
