...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditMonthPage.aspx.cs" Inherits="BS.UI.EditMonthPage" %>
...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.EditMonthPage" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="MonthDialogTitle" Text="Edit Month">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
