...
// This file implements the code-behind class for EditYearTablePage.aspx.
// App_Code\EditYearTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditYearTablePage
        : BaseApplicationPage
// Code-behind class for the EditYearTablePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.YearTableControl.LoadData();
                    this.YearTableControl.DataBind();           
