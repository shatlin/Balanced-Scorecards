...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.AddYearPage" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddYearPage.aspx.cs" Inherits="BS.UI.AddYearPage" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>AddYearPage</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="pbTable">
            ...
            <tr>
                ...
                <asp:UpdateProgress runat="server" id="YearRecordControlUpdateProgress" AssociatedUpdatePanelID="YearRecordControlUpdatePanel">
										<ProgressTemplate>
									...
									<asp:UpdatePanel runat="server" id="YearRecordControlUpdatePanel" UpdateMode="Conditional">

										<ContentTemplate>
											<BS:YearRecordControl runat="server" id="YearRecordControl">
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="YearDialogTitle" Text="Add Year">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
    ...
    <td class="field_label_on_side">
        <asp:Literal runat="server" id="YearValueLabel" Text="Year Value">
														</asp:Literal>
    </td>
    <td class="dialog_field_value">
        <asp:TextBox runat="server" id="YearValue" Columns="50" MaxLength="50" CssClass="field_input" EnableIncrementDecrementButtons="True">
														</asp:TextBox>&nbsp;
