...
// This file implements the code-behind class for EditYearPage.aspx.
// App_Code\EditYearPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditYearPage
        : BaseApplicationPage
// Code-behind class for the EditYearPage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.YearRecordControl.LoadData();
                    this.YearRecordControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.YearRecordControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.YearRecordControl != null && this.YearRecordControl.DataSource != null){
                id = this.YearRecordControl.DataSource.YearId.ToString();
                value = this.YearRecordControl.DataSource.GetValue(this.YearRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
