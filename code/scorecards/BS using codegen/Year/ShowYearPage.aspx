<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.ShowYearPage" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowYearPage.aspx.cs" Inherits="BS.UI.ShowYearPage" %>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="YearRecordControlUpdateProgress" AssociatedUpdatePanelID="YearRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="YearDialogTitle" Text="Show Year">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="YearDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../Year/EditYearPage.aspx?Year={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="YearValue">
														</asp:Literal>
 ...
 <tr>
    ...
    <td>
        ...
        <td class="tre">
            ...
            <th class="thc" scope="col"><asp:Literal runat="server" id="MonthIdLabel" Text="Month">
																						</asp:Literal>
                </th>
            </tr>
            </div>
...
<br/>
    ...
    <td><BS:ThemeButton runat="server" id="EditButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="../Year/EditYearPage.aspx?Year={PK}" Button-Text="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>">
																</BS:ThemeButton></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
