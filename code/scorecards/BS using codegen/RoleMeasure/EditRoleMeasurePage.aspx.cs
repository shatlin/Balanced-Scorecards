...
// This file implements the code-behind class for EditRoleMeasurePage.aspx.
// App_Code\EditRoleMeasurePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditRoleMeasurePage
        : BaseApplicationPage
// Code-behind class for the EditRoleMeasurePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.RoleMeasureRecordControl.LoadData();
                    this.RoleMeasureRecordControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.RoleMeasureRecordControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.RoleMeasureRecordControl != null && this.RoleMeasureRecordControl.DataSource != null){
                id = this.RoleMeasureRecordControl.DataSource.RoleMeasureId.ToString();
                value = this.RoleMeasureRecordControl.DataSource.GetValue(this.RoleMeasureRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
