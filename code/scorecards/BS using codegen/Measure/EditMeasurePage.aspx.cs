...
// This file implements the code-behind class for EditMeasurePage.aspx.
// App_Code\EditMeasurePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditMeasurePage
        : BaseApplicationPage
// Code-behind class for the EditMeasurePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.MeasureRecordControl.LoadData();
                    this.MeasureRecordControl.DataBind();           
          
                    this.MeasureRoleDetailTableControl.LoadData();
                    this.MeasureRoleDetailTableControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.MeasureRecordControl.SaveData();
              
                }
        
                if (!this.IsPageRefresh) {
            
                    this.MeasureRoleDetailTableControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.MeasureRecordControl != null && this.MeasureRecordControl.DataSource != null){
                id = this.MeasureRecordControl.DataSource.MeasureId.ToString();
                value = this.MeasureRecordControl.DataSource.GetValue(this.MeasureRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
