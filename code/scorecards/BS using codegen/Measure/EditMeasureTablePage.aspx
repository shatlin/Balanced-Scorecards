...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.EditMeasureTablePage" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditMeasureTablePage.aspx.cs" Inherits="BS.UI.EditMeasureTablePage" %>
<%@ Register Tagprefix="BS" TagName="Pagination" Src="../Shared/Pagination.ascx" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>EditMeasureTablePage</title>
 ...
 <tr>
    ...
    <td>
        ...
        <td class="tre">
            ...
            <th class="thc" scope="col"><asp:LinkButton runat="server" id="MeasureTypeIdLabel1" Text="Measure Type" CausesValidation="False">
															</asp:LinkButton>
                </th>
            </tr>
            </div>
            ...
            <td class="ttc" style="white-space:nowrap;"><asp:DropDownList runat="server" id="MeasureTypeId" CssClass="field_input" EnableIncrementDecrementButtons="True" onkeypress="dropDownListTypeAhead(this,false)">
																				</asp:DropDownList>
            ...
            <asp:ImageButton runat="server" id="MeasureTypeIdAddRecordLink" CausesValidation="False" CommandName="Redirect" Consumers="MeasureTableControl" ControlToUpdate="MeasureTypeId" FieldValue="MeasureTypeId" ImageURL="../Images/iconNewFlat.gif" RedirectURL="../MeasureType/AddMeasureTypePage.aspx" ToolTip="&lt;%# GetResourceValue(&quot;Btn:New&quot;, &quot;BS&quot;) %>" AlternateText="">
