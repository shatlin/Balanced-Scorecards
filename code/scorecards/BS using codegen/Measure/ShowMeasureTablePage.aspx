...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.ShowMeasureTablePage" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowMeasureTablePage.aspx.cs" Inherits="BS.UI.ShowMeasureTablePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>ShowMeasureTablePage</title>
...
<table class="dv" cellpadding="0" cellspacing="0" border="0">
 ...
 <tr>
    ...
    <tr>
        <td class="fila"><asp:Literal runat="server" id="MeasureTypeIdLabel" Text="Measure Type">
															</asp:Literal></td>
        <td><asp:DropDownList runat="server" id="MeasureTypeIdFilter" CssClass="Filter_Input" onkeypress="dropDownListTypeAhead(this,false)" AutoPostBack="True">
															</asp:DropDownList></td>
    </tr>
    <tr>
    ...
    <td>
        ...
        <td class="tre">
            ...
            <th class="thc" scope="col"><asp:Literal runat="server" id="MeasureTypeIdLabel1" Text="Measure Type">
															</asp:Literal>
                </th>
            </tr>
            </div>
            ...
            <td class="ttc" ><asp:LinkButton runat="server" id="MeasureTypeId" CausesValidation="False" CommandName="Redirect" RedirectURL="../MeasureType/ShowMeasureTypePage.aspx?MeasureType={MeasureTableControlRow:FK:FK_Measure_MeasureType}">
																				</asp:LinkButton>
            </td>
            </tr>
            </div>
...
<br/>
        ...
        <tr>
            ...
            <td class="pbBR"><img src="../Images/space.gif" alt=""/></td>
												...
												<img src="../Images/updating.gif"></td>
        </tr>
        </table>
