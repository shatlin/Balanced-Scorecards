...
// This file implements the code-behind class for EditMeasureTypePage.aspx.
// App_Code\EditMeasureTypePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditMeasureTypePage
        : BaseApplicationPage
// Code-behind class for the EditMeasureTypePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.MeasureTypeRecordControl.LoadData();
                    this.MeasureTypeRecordControl.DataBind();           
          
                    this.MeasureTableControl.LoadData();
                    this.MeasureTableControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.MeasureTypeRecordControl.SaveData();
              
                }
        
                if (!this.IsPageRefresh) {
            
                    this.MeasureTableControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.MeasureTypeRecordControl != null && this.MeasureTypeRecordControl.DataSource != null){
                id = this.MeasureTypeRecordControl.DataSource.MeasureTypeId.ToString();
                value = this.MeasureTypeRecordControl.DataSource.GetValue(this.MeasureTypeRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
