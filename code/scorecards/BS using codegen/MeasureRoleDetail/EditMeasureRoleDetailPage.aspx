...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditMeasureRoleDetailPage.aspx.cs" Inherits="BS.UI.EditMeasureRoleDetailPage" %>
<%@ Register Tagprefix="BS" TagName="Header" Src="../Header and Footer/Header.ascx" %>

<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.EditMeasureRoleDetailPage" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>EditMeasureRoleDetailPage</title>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="MeasureRoleDetailDialogTitle" Text="Edit Measure Role Detail">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
