...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowMeasureRoleDetailPage.aspx.cs" Inherits="BS.UI.ShowMeasureRoleDetailPage" %>
...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.ShowMeasureRoleDetailPage" %>

<%@ Register Tagprefix="BaseClasses" Namespace="BaseClasses.Web.UI.WebControls" Assembly="BaseClasses" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>ShowMeasureRoleDetailPage</title>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="MeasureRoleDetailRecordControlUpdateProgress" AssociatedUpdatePanelID="MeasureRoleDetailRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="MeasureRoleDetailDialogTitle" Text="Show Measure Role Detail">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="MeasureRoleDetailDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../MeasureRoleDetail/EditMeasureRoleDetailPage.aspx?MeasureRoleDetail={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:LinkButton runat="server" id="MeasureId" CausesValidation="False" CommandName="Redirect" RedirectURL="../Measure/ShowMeasurePage.aspx?Measure={MeasureRoleDetailRecordControl:FK:FK_MeasureAppUserDetail_Measure}">
														</asp:LinkButton>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="Actual">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="Target">
														</asp:Literal>
    ...
    <td class="dialog_field_value">
        <asp:LinkButton runat="server" id="MonthId" CausesValidation="False" CommandName="Redirect" RedirectURL="../Month/ShowMonthPage.aspx?Month={MeasureRoleDetailRecordControl:FK:FK_MeasureAppUserDetail_Month}">
														</asp:LinkButton>
    ...
    <td class="dialog_field_value">
        <asp:LinkButton runat="server" id="YearId" CausesValidation="False" CommandName="Redirect" RedirectURL="../Year/ShowYearPage.aspx?Year={MeasureRoleDetailRecordControl:FK:FK_MeasureAppUserDetail_Year1}">
														</asp:LinkButton>
...
<br/>
    ...
    <td><BS:ThemeButton runat="server" id="EditButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="../MeasureRoleDetail/EditMeasureRoleDetailPage.aspx?MeasureRoleDetail={PK}" Button-Text="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>">
										</BS:ThemeButton></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
