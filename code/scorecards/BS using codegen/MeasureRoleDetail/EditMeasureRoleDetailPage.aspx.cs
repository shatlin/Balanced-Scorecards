...
// This file implements the code-behind class for EditMeasureRoleDetailPage.aspx.
// App_Code\EditMeasureRoleDetailPage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditMeasureRoleDetailPage
        : BaseApplicationPage
// Code-behind class for the EditMeasureRoleDetailPage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public EditMeasureRoleDetailPage()
        {
            this.Initialize();
        }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.MeasureRoleDetailRecordControl.LoadData();
                    this.MeasureRoleDetailRecordControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.MeasureRoleDetailRecordControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.MeasureRoleDetailRecordControl != null && this.MeasureRoleDetailRecordControl.DataSource != null){
                id = this.MeasureRoleDetailRecordControl.DataSource.MeasureDetailId.ToString();
                value = this.MeasureRoleDetailRecordControl.DataSource.GetValue(this.MeasureRoleDetailRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
