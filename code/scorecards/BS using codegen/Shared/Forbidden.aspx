		...
		<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="600" id="AutoNumber1">
		  	...
		  	<td class="dialog_header" colspan="3">
				<table cellpadding="0" cellspacing="0" border="0" width="100%">
				  <tr>
					...
					<td class="dialog_header_text" style="font-size:15px;">Forbidden</td>
		  ...
		  <tr>
			...
			<td class="configureErrorPagesText"><br />
				The security settings of the application do not permit you to view this page.<br /><br /> 
				If you believe this is an error, please contact your system administrator to change the security settings.<br /><br />
		    </td>
		  	<td width="20"></td>
		  </tr>
		</table>
