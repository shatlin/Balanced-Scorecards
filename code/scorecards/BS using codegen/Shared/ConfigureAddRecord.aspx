		...
		<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" width="600" id="AutoNumber1">
		  ...
		  <tr>
			...
			<td class="configureErrorPagesText"><br />
				...
				You can bind the New button or icon to an Add Record page by doing the following:<br /><br />
			    <ol>
			      <li>If you have not yet created an Add Record page, use the Application Builder to create one or create one by hand.<br /><br /></li>
			      <li>Go to the Application Explorer tab, navigate in the tree to the page that contains the New button or icon, then click the Page Properties button on the tool bar.<br /><br />
