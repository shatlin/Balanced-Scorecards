<%@ Page Language="cs" AutoEventWireup="true" EnableEventValidation="false" CodeFile="LargeListSelector.aspx.cs" Inherits="BS.UI.LargeListSelector" %>
<%@ Register Tagprefix="BS" TagName="Pagination" Src="Pagination.ascx" %>

<%@ Register Tagprefix="Selectors" Namespace="BS" %>

<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.LargeListSelector" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body id="Body1" runat="server">
	<form id="Form1" method="post" runat="server">
		...
		<ContentTemplate>    
<BS:ItemsTable runat="server" id="ItemsTable">
...
<table>
 <tr>
  ...
  <td style="vertical-align:middle;">
   <BS:ThemeButton runat="server" id="SearchButton" Button-CausesValidation="False" Button-CommandName="Search" Button-Text="<%# GetResourceValue(&quot;Btn:SearchGoButtonText&quot;, &quot;BS&quot;) %>">
			</BS:ThemeButton>
  </td>
 </tr>
</table>
...
<table cellpadding="0" cellspacing="0" border="0">
 <tr>
  ...
  <td class="pagination_area" style="width:100%;">
	<BS:Pagination runat="server" id="Pagination"></BS:Pagination>
  </td>
...
<!-- END Pagination -->
		...
		<asp:Repeater runat="server" id="Row1">
					<ITEMTEMPLATE>
							<BS:ItemsTableRecordControl runat="server" id="ItemsTableRecordControl">
