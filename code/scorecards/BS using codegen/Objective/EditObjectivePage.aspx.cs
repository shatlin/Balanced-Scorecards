...
// This file implements the code-behind class for EditObjectivePage.aspx.
// App_Code\EditObjectivePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditObjectivePage
        : BaseApplicationPage
// Code-behind class for the EditObjectivePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.ObjectiveRecordControl.LoadData();
                    this.ObjectiveRecordControl.DataBind();           
        ...
        // Write out event methods for the page events
          ...
          if (TargetKey != null){
            ...
            try {
                ...
                if (!this.IsPageRefresh) {
                    ...
                    this.ObjectiveRecordControl.SaveData();
          ...
          if(TargetKey != null){
            ...
            if (this.ObjectiveRecordControl != null && this.ObjectiveRecordControl.DataSource != null){
                id = this.ObjectiveRecordControl.DataSource.ObjectiveId.ToString();
                value = this.ObjectiveRecordControl.DataSource.GetValue(this.ObjectiveRecordControl.DataSource.TableAccess.TableDefinition.ColumnList.GetByAnyName(DFKA)).ToString();
                if(value == null){
                  value = id;
                }
