<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.EditObjectivePage" %>
...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="EditObjectivePage.aspx.cs" Inherits="BS.UI.EditObjectivePage" %>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="ObjectiveDialogTitle" Text="Edit Objective">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
