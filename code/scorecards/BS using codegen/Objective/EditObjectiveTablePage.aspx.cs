...
// This file implements the code-behind class for EditObjectiveTablePage.aspx.
// App_Code\EditObjectiveTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditObjectiveTablePage
        : BaseApplicationPage
// Code-behind class for the EditObjectiveTablePage page.
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.ObjectiveTableControl.LoadData();
                    this.ObjectiveTableControl.DataBind();           
