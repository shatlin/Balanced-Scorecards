...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.AddObjectivePage" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddObjectivePage.aspx.cs" Inherits="BS.UI.AddObjectivePage" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
    <title>AddObjectivePage</title>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <table cellspacing="0" cellpadding="0" border="0" class="pbTable">
            ...
            <tr>
                ...
                <asp:UpdateProgress runat="server" id="ObjectiveRecordControlUpdateProgress" AssociatedUpdatePanelID="ObjectiveRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="ObjectiveDialogTitle" Text="Add Objective">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
    ...
    <td class="dialog_field_value">
        <asp:TextBox runat="server" id="ObjectiveName" MaxLength="50" Columns="60" CssClass="field_input" EnableIncrementDecrementButtons="True" Rows="6" TextMode="MultiLine">
														</asp:TextBox>&nbsp;
 ...
 <tr>
    ...
    <td>
        ...
        <td class="tre">
            ...
            <tr><td class="tice" scope="row"></td><td class="tice" scope="row"></td><td class="tic" scope="row"><asp:ImageButton runat="server" id="RoleMeasureRecordRowDeleteButton" CausesValidation="False" CommandArgument="DeleteOnUpdate" CommandName="DeleteRecord" ConfirmMessage="&lt;%# GetResourceValue(&quot;DeleteRecordConfirm&quot;, &quot;BS&quot;) %>" Consumers="RoleMeasureTableControlRow" ImageURL="../Images/icon_delete.gif" ToolTip="&lt;%# GetResourceValue(&quot;Txt:DeleteRecord&quot;, &quot;BS&quot;) %>" AlternateText="">
