...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowObjectivePage.aspx.cs" Inherits="BS.UI.ShowObjectivePage" %>
...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.ShowObjectivePage" %>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="ObjectiveRecordControlUpdateProgress" AssociatedUpdatePanelID="ObjectiveRecordControlUpdatePanel">
										<ProgressTemplate>
									...
									<asp:UpdatePanel runat="server" id="ObjectiveRecordControlUpdatePanel" UpdateMode="Conditional">

										<ContentTemplate>
											<BS:ObjectiveRecordControl runat="server" id="ObjectiveRecordControl">
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="ObjectiveDialogTitle" Text="Show Objective">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="ObjectiveDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../Objective/EditObjectivePage.aspx?Objective={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>" AlternateText="">
    ...
    <td class="field_label_on_side">
        <asp:Literal runat="server" id="ObjectiveNameLabel" Text="Objective Name">
														</asp:Literal>
    </td>
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="ObjectiveName">
														</asp:Literal>
...
<br/>
    ...
    <td><BS:ThemeButton runat="server" id="EditButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="../Objective/EditObjectivePage.aspx?Objective={PK}" Button-Text="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>">
																</BS:ThemeButton></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
