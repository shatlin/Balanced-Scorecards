...
// EditMonthTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditMonthTablePage
{
...
// Base class for the MonthTableControlRow control on the EditMonthTablePage page.
...
public class BaseMonthTableControlRow : BS.UI.BaseApplicationRecordControl
{
        ...
        public virtual void GetUIData()
        {
            ...
            this.DataSource.Parse(this.MonthName.Text, MonthTable.MonthName);
        ...
        MonthTableControl tc= ((MonthTableControl)MiscUtils.GetParentControlObject(this, "MonthTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((MonthTableControlRow)this);
                    }
                    this.Visible = false;
                }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.TextBox MonthName {
            get {
                return (System.Web.UI.WebControls.TextBox)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MonthName");
            }
        }
...
// Base class for the MonthTableControl control on the EditMonthTablePage page.
...
public class BaseMonthTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.MonthNameLabel1.Click += new EventHandler(MonthNameLabel1_Click);
            

            // Setup the button events.
        
              this.MonthAddButton.Click += new ImageClickEventHandler(MonthAddButton_Click);
              ...
              this.MonthSaveButton.Click += new ImageClickEventHandler(MonthSaveButton_Click);
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for sorting events.
              ...
              public virtual void MonthNameLabel1_Click(object sender, EventArgs args)
              {
              
            OrderByItem sd = this.CurrentSortOrder.Find(MonthTable.MonthName);
            if (sd != null) {
                sd.Reverse();
            } else {
                this.CurrentSortOrder.Reset();
                this.CurrentSortOrder.Add(MonthTable.MonthName, OrderByItem.OrderDir.Asc);
            }
        ...
        // Generate the event handling functions for button events.
              ...
              // event handler for ImageButton
              public virtual void MonthAddButton_Click(object sender, ImageClickEventArgs args)
              {
            ...
            if (!this.Page.IsPageRefresh) {
              ...
              // event handler for ImageButton
              public virtual void MonthSaveButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MonthAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MonthAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton MonthSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MonthSaveButton");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton MonthNameLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MonthNameLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public MonthTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MonthTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditMonthTablePage.MonthTableControlRow")));
        ...
        public MonthTableControlRow[] GetRecordControls()
        {
            ...
            return (MonthTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditMonthTablePage.MonthTableControlRow"));
        }
