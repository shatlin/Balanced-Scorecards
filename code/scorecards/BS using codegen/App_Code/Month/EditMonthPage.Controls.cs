...
// EditMonthPage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditMonthPage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the EditMonthPage page.
...
// Base class for the MeasureRoleDetailTableControl control on the EditMonthPage page.
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditMonthPage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditMonthPage.MeasureRoleDetailTableControlRow"));
        }
...
// Base class for the MonthRecordControl control on the EditMonthPage page.
