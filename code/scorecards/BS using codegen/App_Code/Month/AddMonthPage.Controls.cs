...
// AddMonthPage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.AddMonthPage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the AddMonthPage page.
...
// Base class for the MeasureRoleDetailTableControl control on the AddMonthPage page.
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.AddMonthPage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.AddMonthPage.MeasureRoleDetailTableControlRow"));
        }
...
// Base class for the MonthRecordControl control on the AddMonthPage page.
...
public class BaseMonthRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = (MonthRecord)MonthRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in MonthRecord.TableUtils.TableDefinition.Columns){
