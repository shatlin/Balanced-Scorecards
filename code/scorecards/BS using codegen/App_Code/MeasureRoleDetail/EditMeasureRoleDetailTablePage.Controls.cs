...
// EditMeasureRoleDetailTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditMeasureRoleDetailTablePage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the EditMeasureRoleDetailTablePage page.
...
// Base class for the MeasureRoleDetailTableControl control on the EditMeasureRoleDetailTablePage page.
...
public class BaseMeasureRoleDetailTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the button events.
              ...
              this.MeasureRoleDetailSaveButton.Click += new ImageClickEventHandler(MeasureRoleDetailSaveButton_Click);
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for button events.
            ...
            if (!this.Page.IsPageRefresh) {
              ...
              // event handler for ImageButton
              public virtual void MeasureRoleDetailSaveButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MeasureRoleDetailSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureRoleDetailSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditMeasureRoleDetailTablePage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditMeasureRoleDetailTablePage.MeasureRoleDetailTableControlRow"));
        }
