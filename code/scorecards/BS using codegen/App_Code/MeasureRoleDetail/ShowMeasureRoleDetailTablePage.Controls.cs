...
// ShowMeasureRoleDetailTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.ShowMeasureRoleDetailTablePage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the ShowMeasureRoleDetailTablePage page.
...
// Base class for the MeasureRoleDetailTableControl control on the ShowMeasureRoleDetailTablePage page.
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.ShowMeasureRoleDetailTablePage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.ShowMeasureRoleDetailTablePage.MeasureRoleDetailTableControlRow"));
        }
