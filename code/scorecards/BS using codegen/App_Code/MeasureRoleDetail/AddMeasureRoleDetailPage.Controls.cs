...
// AddMeasureRoleDetailPage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.AddMeasureRoleDetailPage
{
...
// Base class for the MeasureRoleDetailRecordControl control on the AddMeasureRoleDetailPage page.
...
public class BaseMeasureRoleDetailRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = (MeasureRoleDetailRecord)MeasureRoleDetailRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in MeasureRoleDetailRecord.TableUtils.TableDefinition.Columns){
...
#region "Helper Functions"
      ...
      if (rec == null && url.IndexOf("{") >= 0) {
        ...
        public MeasureRoleDetailRecord GetRecord()
        {
            ...
            return new MeasureRoleDetailRecord();
