...
// EditObjectivePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditObjectivePage
{
...
// Base class for the RoleMeasureTableControlRow control on the EditObjectivePage page.
...
// Base class for the RoleMeasureTableControl control on the EditObjectivePage page.
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditObjectivePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditObjectivePage.RoleMeasureTableControlRow"));
        }
...
// Base class for the ObjectiveRecordControl control on the EditObjectivePage page.
