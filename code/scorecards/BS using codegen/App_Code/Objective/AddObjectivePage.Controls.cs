...
// AddObjectivePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.AddObjectivePage
{
...
// Base class for the RoleMeasureTableControlRow control on the AddObjectivePage page.
...
// Base class for the RoleMeasureTableControl control on the AddObjectivePage page.
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.AddObjectivePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.AddObjectivePage.RoleMeasureTableControlRow"));
        }
...
// Base class for the ObjectiveRecordControl control on the AddObjectivePage page.
...
public class BaseObjectiveRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = (ObjectiveRecord)ObjectiveRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in ObjectiveRecord.TableUtils.TableDefinition.Columns){
