...
// EditRoleMeasureTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditRoleMeasureTablePage
{
...
// Base class for the RoleMeasureTableControlRow control on the EditRoleMeasureTablePage page.
...
// Base class for the RoleMeasureTableControl control on the EditRoleMeasureTablePage page.
...
public class BaseRoleMeasureTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the button events.
              ...
              this.RoleMeasureSaveButton.Click += new ImageClickEventHandler(RoleMeasureSaveButton_Click);
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for button events.
            ...
            if (!this.Page.IsPageRefresh) {
              ...
              // event handler for ImageButton
              public virtual void RoleMeasureSaveButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton RoleMeasureSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "RoleMeasureSaveButton");
            }
        }
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditRoleMeasureTablePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditRoleMeasureTablePage.RoleMeasureTableControlRow"));
        }
