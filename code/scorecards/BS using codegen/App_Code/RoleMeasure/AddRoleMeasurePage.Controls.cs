...
// AddRoleMeasurePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.AddRoleMeasurePage
{
...
// Base class for the RoleMeasureRecordControl control on the AddRoleMeasurePage page.
...
public class BaseRoleMeasureRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = (RoleMeasureRecord)RoleMeasureRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in RoleMeasureRecord.TableUtils.TableDefinition.Columns){
