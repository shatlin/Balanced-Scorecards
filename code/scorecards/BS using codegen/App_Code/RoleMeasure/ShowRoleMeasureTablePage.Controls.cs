...
// ShowRoleMeasureTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.ShowRoleMeasureTablePage
{
...
// Base class for the RoleMeasureTableControlRow control on the ShowRoleMeasureTablePage page.
...
// Base class for the RoleMeasureTableControl control on the ShowRoleMeasureTablePage page.
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.ShowRoleMeasureTablePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.ShowRoleMeasureTablePage.RoleMeasureTableControlRow"));
        }
