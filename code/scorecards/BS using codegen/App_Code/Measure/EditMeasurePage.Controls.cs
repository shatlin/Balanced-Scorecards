...
// EditMeasurePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditMeasurePage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the EditMeasurePage page.
...
// Base class for the MeasureRoleDetailTableControl control on the EditMeasurePage page.
...
public class BaseMeasureRoleDetailTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.MonthIdLabel1.Click += new EventHandler(MonthIdLabel1_Click);
            
              this.YearIdLabel.Click += new EventHandler(YearIdLabel_Click);
    ...
    // Setup default pagination settings.
            ...
            if (!this.ResetData)
            {
                ...
                foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
                {
                    ...
                    if (recControl.Visible && recControl.IsNewRecord) {
                        ...
                        if (MiscUtils.IsValueSelected(recControl.YearId)) {
                            rec.Parse(recControl.YearId.SelectedItem.Value, MeasureRoleDetailTable.YearId);
                        }
        ...
        // Generate the event handling functions for sorting events.
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void MonthIdLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void YearIdLabel_Click(object sender, EventArgs args)
              {
              
            OrderByItem sd = this.CurrentSortOrder.Find(MeasureRoleDetailTable.YearId);
            if (sd != null) {
                sd.Reverse();
            } else {
                this.CurrentSortOrder.Reset();
                this.CurrentSortOrder.Add(MeasureRoleDetailTable.YearId, OrderByItem.OrderDir.Asc);
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton MonthIdLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MonthIdLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton YearIdLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YearIdLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditMeasurePage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditMeasurePage.MeasureRoleDetailTableControlRow"));
        }
...
// Base class for the RoleMeasureTableControlRow control on the EditMeasurePage page.
...
public class BaseRoleMeasureTableControlRow : BS.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.OrgRoleId1.SelectedIndexChanged += new EventHandler(OrgRoleId1_SelectedIndexChanged);
        ...
        public override void DataBind()
        {
            ...
            if (this.DataSource.OrgRoleIdSpecified) {
                this.PopulateOrgRoleId1DropDownList(this.DataSource.OrgRoleId.ToString(), 100);
            } else {
                if (!this.DataSource.IsCreated) {
                    this.PopulateOrgRoleId1DropDownList(RoleMeasureTable.OrgRoleId.DefaultValue, 100);
                } else {
                this.PopulateOrgRoleId1DropDownList(null, 100);
                }
            }
        ...
        public virtual void GetUIData()
        {
            ...
            this.DataSource.Parse(MiscUtils.GetValueSelectedPageRequest(this.OrgRoleId1), RoleMeasureTable.OrgRoleId);
        ...
        public virtual WhereClause CreateWhereClause_OrgRoleId1DropDownList() {
            return new WhereClause();
        }
        ...
        // Fill the OrgRoleId1 list.
        protected virtual void PopulateOrgRoleId1DropDownList
                (string selectedValue, int maxItems) {
                  
            //Setup the WHERE clause.
            WhereClause wc = CreateWhereClause_OrgRoleId1DropDownList();
            OrderBy orderBy = new OrderBy(false, true);
            orderBy.Add(OrgRoleTable.OrgRoleName, OrderByItem.OrderDir.Asc);

                      this.OrgRoleId1.Items.Clear();
            foreach (OrgRoleRecord itemValue in OrgRoleTable.GetRecords(wc, orderBy, 0, maxItems)) {
                // Create the item and add to the list.
                string cvalue = null;
                string fvalue = null;
                ...
                ListItem item = new ListItem(fvalue, cvalue);
                this.OrgRoleId1.Items.Add(item);
            }
                    
            // Setup the selected item.
            if (selectedValue != null &&
                selectedValue.Length > 0 &&
                !MiscUtils.SetSelectedValue(this.OrgRoleId1, selectedValue) &&
                !MiscUtils.SetSelectedValue(this.OrgRoleId1, RoleMeasureTable.OrgRoleId.Format(selectedValue))) {
                string fvalue = RoleMeasureTable.OrgRoleId.Format(selectedValue);
                ListItem item = new ListItem(fvalue, selectedValue);
                item.Selected = true;
                this.OrgRoleId1.Items.Insert(0, item);
            }

                  
            this.OrgRoleId1.Items.Insert(0, new ListItem(Page.GetResourceValue("Txt:PleaseSelect", "BS"), "--PLEASE_SELECT--"));
        ...
        RoleMeasureTableControl tc= ((RoleMeasureTableControl)MiscUtils.GetParentControlObject(this, "RoleMeasureTableControl"));
            ...
            this.Page.CloseWindow(true);
              ...
              protected virtual void OrgRoleId1_SelectedIndexChanged(object sender, EventArgs args)
              {
              string selectedValue = MiscUtils.GetValueSelectedPageRequest(this.OrgRoleId1);
              if (selectedValue != null &&
              selectedValue.Length > 0 &&
              !MiscUtils.SetSelectedValue(this.OrgRoleId1, selectedValue) &&
              !MiscUtils.SetSelectedValue(this.OrgRoleId1, RoleMeasureTable.OrgRoleId.Format(selectedValue))) {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.DropDownList OrgRoleId1 {
            get {
                return (System.Web.UI.WebControls.DropDownList)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "OrgRoleId1");
            }
        }
...
// Base class for the RoleMeasureTableControl control on the EditMeasurePage page.
...
public class BaseRoleMeasureTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.OrgRoleIdLabel3.Click += new EventHandler(OrgRoleIdLabel3_Click);
            
              this.ObjectiveIdLabel1.Click += new EventHandler(ObjectiveIdLabel1_Click);
            
              this.PerspectiveidLabel.Click += new EventHandler(PerspectiveidLabel_Click);
    ...
    // Setup default pagination settings.
            ...
            if (!this.ResetData)
            {
                ...
                foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
                {
                    ...
                    if (recControl.Visible && recControl.IsNewRecord) {
                        ...
                        if (MiscUtils.IsValueSelected(recControl.OrgRoleId1)) {
                            rec.Parse(recControl.OrgRoleId1.SelectedItem.Value, RoleMeasureTable.OrgRoleId);
                        }
                        ...
                        if (MiscUtils.IsValueSelected(recControl.Perspectiveid)) {
                            rec.Parse(recControl.Perspectiveid.SelectedItem.Value, RoleMeasureTable.Perspectiveid);
                        }
                        newRecordList.Add(rec);
                    }
                }
        ...
        // Generate the event handling functions for sorting events.
              ...
              // event handler for FieldSort
              public virtual void OrgRoleIdLabel3_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void ObjectiveIdLabel1_Click(object sender, EventArgs args)
              {
            ...
            this.DataChanged = true;
              ...
              // event handler for FieldSort
              public virtual void PerspectiveidLabel_Click(object sender, EventArgs args)
              {
              
            OrderByItem sd = this.CurrentSortOrder.Find(RoleMeasureTable.Perspectiveid);
            if (sd != null) {
                sd.Reverse();
            } else {
                this.CurrentSortOrder.Reset();
                this.CurrentSortOrder.Add(RoleMeasureTable.Perspectiveid, OrderByItem.OrderDir.Asc);
            }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.LinkButton OrgRoleIdLabel3 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "OrgRoleIdLabel3");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton ObjectiveIdLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "ObjectiveIdLabel1");
            }
        }
        
        public System.Web.UI.WebControls.LinkButton PerspectiveidLabel {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PerspectiveidLabel");
            }
        }
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditMeasurePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditMeasurePage.RoleMeasureTableControlRow"));
        }
...
// Base class for the MeasureRecordControl control on the EditMeasurePage page.
