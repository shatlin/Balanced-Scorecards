...
// ShowMeasureTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.ShowMeasureTablePage
{
...
// Base class for the MeasureTableControlRow control on the ShowMeasureTablePage page.
...
public class BaseMeasureTableControlRow : BS.UI.BaseApplicationRecordControl
{
        ...
        protected override object SaveViewState()
        {
            ...
            string url = @"../MeasureType/ShowMeasureTypePage.aspx?MeasureType={MeasureTableControlRow:FK:FK_Measure_MeasureType}";
            bool shouldRedirect = true;
            string TargetKey = null;
            string DFKA = null;
            string id = null;
...
// Base class for the MeasureTableControl control on the ShowMeasureTablePage page.
            ...
            if (!this.ResetData)
            {
                ...
                foreach (System.Web.UI.WebControls.RepeaterItem repItem in rep.Items)
                {
                    ...
                    if (recControl.Visible && recControl.IsNewRecord) {
                        ...
                        if (recControl.MeasureTypeId.Text != "") {
                            rec.Parse(recControl.MeasureTypeId.Text, MeasureTable.MeasureTypeId);
                        }
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.Literal MeasureTypeIdLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureTypeIdLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public MeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.ShowMeasureTablePage.MeasureTableControlRow")));
        ...
        public MeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.ShowMeasureTablePage.MeasureTableControlRow"));
        }
