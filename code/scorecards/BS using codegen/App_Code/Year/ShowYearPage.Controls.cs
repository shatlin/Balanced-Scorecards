...
// ShowYearPage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.ShowYearPage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the ShowYearPage page.
...
// Base class for the MeasureRoleDetailTableControl control on the ShowYearPage page.
...
public class BaseMeasureRoleDetailTableControl : BS.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for button events.
            ...
            ((YearRecordControl)(this.Page.FindControlRecursively("YearRecordControl"))).ResetData = true;
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.ShowYearPage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.ShowYearPage.MeasureRoleDetailTableControlRow"));
        }
...
// Base class for the YearRecordControl control on the ShowYearPage page.
...
public class BaseYearRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.YearDialogEditButton.Click += new ImageClickEventHandler(YearDialogEditButton_Click);
        }
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = YearTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "BS").Replace("{URL}", "Year"));
            }
        ...
        protected override object SaveViewState()
        {
            ...
            return base.SaveViewState();
              ...
              // event handler for ImageButton
              public virtual void YearDialogEditButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton YearDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YearDialogEditButton");
            }
        }
