...
// EditYearTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditYearTablePage
{
...
// Base class for the YearTableControlRow control on the EditYearTablePage page.
...
public class BaseYearTableControlRow : BS.UI.BaseApplicationRecordControl
{
        ...
        YearTableControl tc= ((YearTableControl)MiscUtils.GetParentControlObject(this, "YearTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((YearTableControlRow)this);
                    }
                    this.Visible = false;
                }
...
// Base class for the YearTableControl control on the EditYearTablePage page.
...
public class BaseYearTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.YearValueLabel1.Click += new EventHandler(YearValueLabel1_Click);
            

            // Setup the button events.
        
              this.YearAddButton.Click += new ImageClickEventHandler(YearAddButton_Click);
              ...
              this.YearSaveButton.Click += new ImageClickEventHandler(YearSaveButton_Click);
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for sorting events.
              ...
              public virtual void YearValueLabel1_Click(object sender, EventArgs args)
              {
              
            OrderByItem sd = this.CurrentSortOrder.Find(YearTable.YearValue);
            if (sd != null) {
                sd.Reverse();
            } else {
                this.CurrentSortOrder.Reset();
                this.CurrentSortOrder.Add(YearTable.YearValue, OrderByItem.OrderDir.Asc);
            }
        ...
        // Generate the event handling functions for button events.
              ...
              // event handler for ImageButton
              public virtual void YearAddButton_Click(object sender, ImageClickEventArgs args)
              {
            ...
            if (!this.Page.IsPageRefresh) {
              ...
              // event handler for ImageButton
              public virtual void YearSaveButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton YearAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YearAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton YearSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YearSaveButton");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton YearValueLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "YearValueLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public YearTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (YearTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditYearTablePage.YearTableControlRow")));
        ...
        public YearTableControlRow[] GetRecordControls()
        {
            ...
            return (YearTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditYearTablePage.YearTableControlRow"));
        }
