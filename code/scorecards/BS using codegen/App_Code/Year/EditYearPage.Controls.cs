...
// EditYearPage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditYearPage
{
...
// Base class for the MeasureRoleDetailTableControlRow control on the EditYearPage page.
...
// Base class for the MeasureRoleDetailTableControl control on the EditYearPage page.
...
#region "Helper Functions"
        ...
        public MeasureRoleDetailTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditYearPage.MeasureRoleDetailTableControlRow")));
        ...
        public MeasureRoleDetailTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureRoleDetailTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditYearPage.MeasureRoleDetailTableControlRow"));
        }
...
// Base class for the YearRecordControl control on the EditYearPage page.
