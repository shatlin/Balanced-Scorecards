...
// AddMeasureTypePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.AddMeasureTypePage
{
...
// Base class for the MeasureTableControlRow control on the AddMeasureTypePage page.
...
// Base class for the MeasureTableControl control on the AddMeasureTypePage page.
...
#region "Helper Functions"
        ...
        public MeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.AddMeasureTypePage.MeasureTableControlRow")));
        ...
        public MeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.AddMeasureTypePage.MeasureTableControlRow"));
        }
...
// Base class for the MeasureTypeRecordControl control on the AddMeasureTypePage page.
...
public class BaseMeasureTypeRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = (MeasureTypeRecord)MeasureTypeRecord.Copy(recList[0], false);
        ...
        public virtual void GetUIData()
        {
            ...
            foreach(BaseColumn col in MeasureTypeRecord.TableUtils.TableDefinition.Columns){
