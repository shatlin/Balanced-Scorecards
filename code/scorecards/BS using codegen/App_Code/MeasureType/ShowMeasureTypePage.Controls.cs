...
// ShowMeasureTypePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.ShowMeasureTypePage
{
...
// Base class for the MeasureTableControlRow control on the ShowMeasureTypePage page.
...
public class BaseMeasureTableControlRow : BS.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.MeasureRecordRowCopyButton.Click += new ImageClickEventHandler(MeasureRecordRowCopyButton_Click);
        }
        ...
        protected override object SaveViewState()
        {
            ...
            if (!this.Page.IsPageRefresh) {
              ...
              // event handler for ImageButton
              public virtual void MeasureRecordRowCopyButton_Click(object sender, ImageClickEventArgs args)
              {
              
            string url = @"../Measure/AddMeasurePage.aspx?Measure={PK}";
            bool shouldRedirect = true;
            string TargetKey = null;
            string DFKA = null;
            string id = null;
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MeasureRecordRowCopyButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureRecordRowCopyButton");
            }
        }
...
// Base class for the MeasureTableControl control on the ShowMeasureTypePage page.
...
public class BaseMeasureTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the button events.
              ...
              this.MeasureNewButton.Click += new ImageClickEventHandler(MeasureNewButton_Click);
              this.MeasureEditButton.Click += new ImageClickEventHandler(MeasureEditButton_Click);
              this.MeasureCopyButton.Click += new ImageClickEventHandler(MeasureCopyButton_Click);
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for button events.
              ...
              // event handler for ImageButton
              public virtual void MeasureNewButton_Click(object sender, ImageClickEventArgs args)
              {
            ...
            this.Page.CloseWindow(true);
              ...
              // event handler for ImageButton
              public virtual void MeasureCopyButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MeasureNewButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureNewButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton MeasureCopyButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureCopyButton");
            }
        }
        ...
        public System.Web.UI.WebControls.Literal MeasureNameLabel1 {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureNameLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public MeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (MeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.ShowMeasureTypePage.MeasureTableControlRow")));
        ...
        public MeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (MeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.ShowMeasureTypePage.MeasureTableControlRow"));
        }
...
// Base class for the MeasureTypeRecordControl control on the ShowMeasureTypePage page.
...
public class BaseMeasureTypeRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.MeasureTypeDialogEditButton.Click += new ImageClickEventHandler(MeasureTypeDialogEditButton_Click);
        }
        ...
        public override void DataBind()
        {
            ...
            if (this.MeasureTypename.Text == null ||
                this.MeasureTypename.Text.Trim().Length == 0) {
                this.MeasureTypename.Text = "&nbsp;";
            }
        ...
        protected override object SaveViewState()
        {
            ...
            return base.SaveViewState();
              ...
              // event handler for ImageButton
              public virtual void MeasureTypeDialogEditButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton MeasureTypeDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureTypeDialogEditButton");
            }
        }
           
        public System.Web.UI.WebControls.Literal MeasureTypename {
            get {
                return (System.Web.UI.WebControls.Literal)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "MeasureTypename");
            }
        }
