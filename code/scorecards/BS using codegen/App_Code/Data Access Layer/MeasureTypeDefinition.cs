...
/// <see cref="MeasureTypeTable">BS.MeasureTypeTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="MeasureTypeTable"></seealso>
public class MeasureTypeDefinition
{
#region "Definition (XML) for MeasureTypeDefinition table"
	//Next 60 lines contain Table Definition (XML) for table "MeasureTypeDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.0"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>MeasureTypename</columnName>" +
      @"<columnUIName>Measure Typename</columnUIName>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>MeasureType</TableName>" +
  @"<Version></Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>MeasureType</TableCodeName>" +
  @"<TableAliasName>MeasureType_</TableAliasName>" +
