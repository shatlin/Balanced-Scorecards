...
/// <see cref="OrgRoleTable">BS.OrgRoleTable</see> class
/// to initialize the class's TableDefinition.
/// </summary>
/// <seealso cref="OrgRoleTable"></seealso>
public class OrgRoleDefinition
{
#region "Definition (XML) for OrgRoleDefinition table"
	//Next 82 lines contain Table Definition (XML) for table "OrgRoleDefinition"
...
@"<XMLDefinition Generator=""Iron Speed Designer"" Version=""5.0"" Type=""GENERIC"">" +
  @"<ColumnDefinition>" +
    ...
    @"<Column InternalName=""1"" Priority=""2"" ColumnNum=""1"">" +
      @"<columnName>OrgRoleName</columnName>" +
      @"<columnUIName>Organization Role Name</columnUIName>" +
    ...
    @"<Column InternalName=""2"" Priority=""3"" ColumnNum=""2"">" +
      @"<columnName>OrgRoleDetail</columnName>" +
      @"<columnUIName>Organization Role Detail</columnUIName>" +
      @"<columnType>String</columnType>" +
      @"<columnDBType>varchar</columnDBType>" +
      @"<columnLengthSet>1000</columnLengthSet>" +
      @"<columnDefault></columnDefault>" +
      @"<columnDBDefault></columnDBDefault>" +
      @"<columnIndex>N</columnIndex>" +
      @"<columnUnique>N</columnUnique>" +
    ...
    "</Column>" +
  "</ColumnDefinition>" +
  @"<TableName>OrgRole</TableName>" +
  @"<Version></Version>" +
  @"<Owner>dbo</Owner>" +
  @"<TableCodeName>OrgRole</TableCodeName>" +
  @"<TableAliasName>OrgRole_</TableAliasName>" +
