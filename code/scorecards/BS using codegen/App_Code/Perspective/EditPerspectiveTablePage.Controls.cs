...
// EditPerspectiveTablePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditPerspectiveTablePage
{
...
// Base class for the PerspectiveTableControlRow control on the EditPerspectiveTablePage page.
...
public class BasePerspectiveTableControlRow : BS.UI.BaseApplicationRecordControl
{
        ...
        PerspectiveTableControl tc= ((PerspectiveTableControl)MiscUtils.GetParentControlObject(this, "PerspectiveTableControl"));
                if (tc != null){
                    if (!this.IsNewRecord){
                        tc.AddToDeletedRecordIds((PerspectiveTableControlRow)this);
                    }
                    this.Visible = false;
                }
...
// Base class for the PerspectiveTableControl control on the EditPerspectiveTablePage page.
...
public class BasePerspectiveTableControl : BS.UI.BaseApplicationTableControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            ...
            // Setup the sorting events.
              ...
              this.PerspectiveNameLabel1.Click += new EventHandler(PerspectiveNameLabel1_Click);
            

            // Setup the button events.
        
              this.PerspectiveAddButton.Click += new ImageClickEventHandler(PerspectiveAddButton_Click);
              ...
              this.PerspectiveSaveButton.Click += new ImageClickEventHandler(PerspectiveSaveButton_Click);
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for sorting events.
              ...
              public virtual void PerspectiveNameLabel1_Click(object sender, EventArgs args)
              {
              
            OrderByItem sd = this.CurrentSortOrder.Find(PerspectiveTable.PerspectiveName);
            if (sd != null) {
                sd.Reverse();
            } else {
                this.CurrentSortOrder.Reset();
                this.CurrentSortOrder.Add(PerspectiveTable.PerspectiveName, OrderByItem.OrderDir.Asc);
            }
        ...
        // Generate the event handling functions for button events.
              ...
              // event handler for ImageButton
              public virtual void PerspectiveAddButton_Click(object sender, ImageClickEventArgs args)
              {
            ...
            if (!this.Page.IsPageRefresh) {
              ...
              // event handler for ImageButton
              public virtual void PerspectiveSaveButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PerspectiveAddButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PerspectiveAddButton");
            }
        }
        ...
        public System.Web.UI.WebControls.ImageButton PerspectiveSaveButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PerspectiveSaveButton");
            }
        }
        ...
        public System.Web.UI.WebControls.LinkButton PerspectiveNameLabel1 {
            get {
                return (System.Web.UI.WebControls.LinkButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PerspectiveNameLabel1");
            }
        }
...
#region "Helper Functions"
        ...
        public PerspectiveTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (PerspectiveTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditPerspectiveTablePage.PerspectiveTableControlRow")));
        ...
        public PerspectiveTableControlRow[] GetRecordControls()
        {
            ...
            return (PerspectiveTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditPerspectiveTablePage.PerspectiveTableControlRow"));
        }
