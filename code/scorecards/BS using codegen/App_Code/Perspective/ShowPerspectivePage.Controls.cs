...
// ShowPerspectivePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.ShowPerspectivePage
{
...
// Base class for the RoleMeasureTableControlRow control on the ShowPerspectivePage page.
...
// Base class for the RoleMeasureTableControl control on the ShowPerspectivePage page.
...
public class BaseRoleMeasureTableControl : BS.UI.BaseApplicationTableControl
{
    ...
    // Setup default pagination settings.
        ...
        // Generate the event handling functions for button events.
            ...
            ((PerspectiveRecordControl)(this.Page.FindControlRecursively("PerspectiveRecordControl"))).ResetData = true;
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.ShowPerspectivePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.ShowPerspectivePage.RoleMeasureTableControlRow"));
        }
...
// Base class for the PerspectiveRecordControl control on the ShowPerspectivePage page.
...
public class BasePerspectiveRecordControl : BS.UI.BaseApplicationRecordControl
{
        ...
        protected virtual void Control_Init(object sender, System.EventArgs e)
        {
            // Register the event handlers.
              ...
              this.PerspectiveDialogEditButton.Click += new ImageClickEventHandler(PerspectiveDialogEditButton_Click);
        }
        ...
        public virtual void LoadData()  
        {
            ...
            if (recList.Length == 0) {
                throw new Exception(Page.GetResourceValue("Err:NoRecRetrieved", "BS"));
                    ...
                    this.DataSource = PerspectiveTable.GetRecord(recList[0].GetID().ToXmlString(), true);
        ...
        public virtual WhereClause CreateWhereClause()
        {
            ...
            if (recId == null || recId.Length == 0) {
                // Get the error message from the application resource file.
                throw new Exception(Page.GetResourceValue("Err:UrlParamMissing", "BS").Replace("{URL}", "Perspective"));
            }
        ...
        protected override object SaveViewState()
        {
            ...
            return base.SaveViewState();
              ...
              // event handler for ImageButton
              public virtual void PerspectiveDialogEditButton_Click(object sender, ImageClickEventArgs args)
              {
...
#region "Helper Properties"
        ...
        public System.Web.UI.WebControls.ImageButton PerspectiveDialogEditButton {
            get {
                return (System.Web.UI.WebControls.ImageButton)BaseClasses.Utils.MiscUtils.FindControlRecursively(this, "PerspectiveDialogEditButton");
            }
        }
