...
// EditPerspectivePage.aspx page.  The Row or RecordControl classes are the 
...
namespace BS.UI.Controls.EditPerspectivePage
{
...
// Base class for the RoleMeasureTableControlRow control on the EditPerspectivePage page.
...
// Base class for the RoleMeasureTableControl control on the EditPerspectivePage page.
...
#region "Helper Functions"
        ...
        public RoleMeasureTableControlRow[] GetSelectedRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])(selectedList.ToArray(Type.GetType("BS.UI.Controls.EditPerspectivePage.RoleMeasureTableControlRow")));
        ...
        public RoleMeasureTableControlRow[] GetRecordControls()
        {
            ...
            return (RoleMeasureTableControlRow[])recList.ToArray(Type.GetType("BS.UI.Controls.EditPerspectivePage.RoleMeasureTableControlRow"));
        }
...
// Base class for the PerspectiveRecordControl control on the EditPerspectivePage page.
