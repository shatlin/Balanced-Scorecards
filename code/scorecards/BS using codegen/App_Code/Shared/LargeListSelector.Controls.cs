...
namespace BS.UI.Controls.LargeListSelector
{
    ...
    public class BaseItemsTableRecordControl : BS.UI.BaseApplicationRecordControl
    {
    ...
    public class BaseItemsTable : BS.UI.BaseApplicationTableControl
    {
	...
	public virtual bool FormatSuggestions(string prefixText, string resultItem, int columnLength, string AutoTypeAheadDisplayFoundText, string autoTypeAheadSearch, string AutoTypeAheadWordSeparators, ArrayList resultList) 
	{
        ...
        public string Table
        {
			...
			return tableName; 
                ...
                try
                {
                    string tableType = string.Format(TYPE_FORMAT, "BS.Business", tableName, "Table", "App_Code");
                ...
                try
                {
                    string viewType = string.Format(TYPE_FORMAT, "BS.Business", tableName, "View", "App_Code");
                ...
                try
                {
                    string queryType = string.Format(TYPE_FORMAT, "BS.Business", tableName, "Query", "App_Code");
        ...
        public BS.UI.IThemeButton SearchButton
        {
            get
            {
                return ((BS.UI.IThemeButton)(MiscUtils.FindControlRecursively(this, "SearchButton")));
            }
        }

        public BS.UI.IPagination Pagination
        {
            get
            {
                return ((BS.UI.IPagination)(MiscUtils.FindControlRecursively(this, "Pagination")));
            }
        }
        ...
        public ItemsTableRecordControl[] GetRecordControls()
        {
            ...
            return ((ItemsTableRecordControl[])(recList.ToArray(Type.GetType("BS.UI.Controls.LargeListSelector.ItemsTableRecordControl"))));
        }
        ...
        public BaseClasses.Data.BaseTable GetTable()
        {
            ...
            {
                tn = string.Format("{0}.{1}Access,{2}", "BS", tn.Replace(" ", "_"), "BS");
                return BaseClasses.Data.BaseTable.CreateInstance(tn);
            }
        }
    }
