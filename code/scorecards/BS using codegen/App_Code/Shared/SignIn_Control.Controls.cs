namespace BS.UI.Controls.SignIn_Control
{
	...
	#region " Protected Properties"
			...
			protected string ERR_INVALID_LOGIN_INFO
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Err:InvalidLoginInfo", "BS");
				}
			...
			protected string ERR_INTERNAL_ERROR
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Err:InternalErrorLogin", "BS");
				}
			...
			protected string LOGIN_MSG
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Txt:LoginMsg", "BS");
				}
			...
			protected string LOGIN_MSG_SESSION_INVALID
			{
				get
				{
                    return ((BaseApplicationPage)(this.Page)).GetResourceValue("Txt:LoginMsgSessionInvalid", "BS");
				}
