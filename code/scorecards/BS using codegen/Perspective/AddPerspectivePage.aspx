...
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.AddPerspectivePage" %>

<%@ Register Tagprefix="BS" TagName="Menu" Src="../Menu Panels/Menu.ascx" %>

<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="AddPerspectivePage.aspx.cs" Inherits="BS.UI.AddPerspectivePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>AddPerspectivePage</title>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("SaveNNewButton$_Button")) %>
 ...
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="PerspectiveDialogTitle" Text="Add Perspective">
														</asp:Literal></td>
    </tr>
    </table>
    </td>	
