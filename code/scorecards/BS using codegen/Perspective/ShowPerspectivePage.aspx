...
<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="false" CodeFile="ShowPerspectivePage.aspx.cs" Inherits="BS.UI.ShowPerspectivePage" %>
<%@ Register Tagprefix="BS" Namespace="BS.UI.Controls.ShowPerspectivePage" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>ShowPerspectivePage</title>
            ...
            <tr>
                ...
                <td class="pcC">			
                    ...
                    <td>
                        ...
                        <tr>
                        <td class="pContent">
                            <a name="StartOfPageContent"></a><asp:UpdateProgress runat="server" id="PerspectiveRecordControlUpdateProgress" AssociatedUpdatePanelID="PerspectiveRecordControlUpdatePanel">
										<ProgressTemplate>
...
<%= SystemUtils.GenerateEnterKeyCaptureBeginTag(FindControl("EditButton$_Button")) %>
 <table class="dialog_view" cellpadding="0" cellspacing="0" border="0">
    ...
    <tr>
    <td class="dhtr" valign="middle"><asp:Literal runat="server" id="PerspectiveDialogTitle" Text="Show Perspective">
														</asp:Literal></td>
    <td class="dhir"><asp:ImageButton runat="server" id="PerspectiveDialogEditButton" CausesValidation="False" CommandName="Redirect" Consumers="page" ImageURL="../Images/iconEdit.gif" RedirectURL="../Perspective/EditPerspectivePage.aspx?Perspective={PK}" ToolTip="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>" AlternateText="">
    ...
    <td class="dialog_field_value">
        <asp:Literal runat="server" id="PerspectiveName">
														</asp:Literal>
...
<br/>
    ...
    <td><BS:ThemeButton runat="server" id="EditButton" Button-CausesValidation="False" Button-CommandName="Redirect" Button-RedirectURL="../Perspective/EditPerspectivePage.aspx?Perspective={PK}" Button-Text="&lt;%# GetResourceValue(&quot;Btn:Edit&quot;, &quot;BS&quot;) %>">
																</BS:ThemeButton></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
    <td></td>
    <td><img src="../Images/space.gif" height="6" width="3" alt=""/></td>
