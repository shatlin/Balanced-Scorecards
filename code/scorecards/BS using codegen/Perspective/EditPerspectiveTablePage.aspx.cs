...
// This file implements the code-behind class for EditPerspectiveTablePage.aspx.
// App_Code\EditPerspectiveTablePage.Controls.vb contains the Table, Row and Record control classes
...
partial class EditPerspectiveTablePage
        : BaseApplicationPage
// Code-behind class for the EditPerspectiveTablePage page.
...
#region "Section 1: Place your customizations here."    
        ...
        public EditPerspectiveTablePage()
        {
            this.Initialize();
        }
    ...
    public void LoadData_Base()
    {
            ...
            try {
                ...
                if ((!this.IsPostBack)) {
                    ...
                    this.PerspectiveTableControl.LoadData();
                    this.PerspectiveTableControl.DataBind();           
