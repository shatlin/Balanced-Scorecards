    ...
    public partial class Location : global::System.Data.DataSet {
        ...
        public partial class LocationDataTable : global::System.Data.DataTable, global::System.Collections.IEnumerable {
            ...
            private void InitClass() {
                ...
                this.columnLocationAddress.MaxLength = 1000;
...
namespace Data.Setup.LocationTableAdapters {
    ...
    public partial class LocationDAL : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Location] WHERE (([LocationId] = @Original_LocationId))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Location] ([LocationName], [LocationAddress]) VALUES (@LocationName," +
                " @LocationAddress)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LocationAddress", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "LocationAddress", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [Location] SET [LocationName] = @LocationName, [LocationAddress] = @Locati" +
                "onAddress WHERE (([LocationId] = @Original_LocationId))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LocationAddress", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "LocationAddress", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     LocationId, LocationName, LocationAddress\r\nFROM         Location";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT    LocationId,  LocationName,LocationAddress\r\nFROM         Location\r\nWHERE" +
                "     (LocationId = @LocationIdParam)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@LocationIdParam", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "LocationId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT     LocationName\r\nFROM         Location\r\nWHERE     (LocationId = @Location" +
                "Id)";
        ...
        public virtual Location.LocationDataTable GetLocations() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        public virtual int FillBy(Location.LocationDataTable dataTable, int LocationIdParam) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(LocationIdParam));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
            int returnValue = this.Adapter.Fill(dataTable);
        ...
        public virtual Location.LocationDataTable GetLocationById(int LocationIdParam) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(LocationIdParam));
            Location.LocationDataTable dataTable = new Location.LocationDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int Update(string LocationName, string LocationAddress, int Original_LocationId) {
            if ((LocationName == null)) {
                throw new global::System.ArgumentNullException("LocationName");
            }
            else {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual object GetLocationNameById(int LocationId) {
