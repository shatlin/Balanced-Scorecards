<%@ Page Language="C#" MasterPageFile="~/common/iMaster.master" AutoEventWireup="true" CodeFile="AgreedRating.aspx.cs" Inherits="CAS_AgreedRating" Title="Untitled Page" %>
                                ...
                                <tr>
                                    ...
                                    <td class="PageInfoTableBod" valign="top" style="height: 110px">
                                        ...
                                        <h4 style="text-align: left">
                                            Please Select One of your SubOrdinates to Rate Him&nbsp;<asp:DropDownList
                                                ID="drpSubordinates" runat="server" AutoPostBack="True" DataSourceID="ObjectDataSource1"
                                                DataTextField="AppUserName" DataValueField="AppUserId" AppendDataBoundItems="true" OnSelectedIndexChanged="drpSubordinates_SelectedIndexChanged">
                                            <asp:ListItem Value=0 Text="Select Subordinate"></asp:ListItem>    
                                            </asp:DropDownList></h4>
                                        <h4>
                                            <asp:Label ID="lblUserInfo" runat="server"></asp:Label>
                                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetSubordinates"
                                                TypeName="Business.Setup.AppUserBL">
                                                <SelectParameters>
                                                    <asp:ControlParameter ControlID="lblOrdinateId" Name="iOrdinateAppUserId" PropertyName="Text"
                                                        Type="Int32" />
                                                </SelectParameters>
                                            </asp:ObjectDataSource>
                                            &nbsp;<asp:Label ID="lblRoleName" runat="server" Visible="False">0</asp:Label>
                                            <asp:Label ID="lblOrdinateId" runat="server" Visible="False"></asp:Label></h4>
                                    </td>
                                    <td valign="top" style="height: 110px">
                                    </td>
                                </tr>
                                       ...
                                       <h1>
                                           <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
                                               ...
                                               <Columns>
                                                   ...
                                                   <asp:TemplateField HeaderText="Role of Your SubOrdinate" SortExpression="OrgRoleId">
                                        ...
                                        <asp:TemplateField HeaderText="OrgRoleId" InsertVisible="False" SortExpression="OrgRoleId"
                                           ...
                                           <ItemTemplate>
                                               <asp:Label ID="Label7" runat="server" Text='<%# Bind("CompetencyId") %>'></asp:Label>
                                                   ...
                                                   <asp:TemplateField HeaderText="His Competency" SortExpression="CompetencyId">
                                                   ...
                                                   <asp:TemplateField HeaderText="Agreed Rating"  >
                                                       <ItemTemplate>
                                                   ...
                                                   <asp:TemplateField HeaderText="Your Rating">
                                                       
                                                       <ItemTemplate>
                                                           <asp:Label ID="LblOrdinateRating" runat="server" Text=""></asp:Label>
                                                       </ItemTemplate>
                                                   </asp:TemplateField>
                                                   
                                                   <asp:TemplateField HeaderText="His Rating">
                                                       
                                                       <ItemTemplate>
                                                           <asp:Label ID="LblSubOrdinateRating" runat="server" Text=""></asp:Label>
                                                       </ItemTemplate>
                                                   </asp:TemplateField>
                                                   
                                                   <asp:BoundField DataField="DesiredRating" HeaderText="Desired Rating For His Role" SortExpression="DesiredRating"/>
