<%@ Page Language="C#" MasterPageFile="~/common/iMaster.master" AutoEventWireup="true" CodeFile="Page Template.aspx.cs" Inherits="Setup_Default" Title="Untitled Page" %>
...
<table width="100%" height="100%" style="vertical-align: top" border="0" cellpadding="0"
        ...
        <tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                ...
                                <tr>
                                    ...
                                    <td valign="top" align="center">
                                       ...
                                       The controls & content goes here
                                ...
                                <tr>
                                   ...
                                   <h1 style="text-align: center">The controls & content goes here</h1>
                                    </td>
                                    <td valign="top">
                                        &nbsp;
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 1010px">
                                       <h1 style="text-align: center">The controls & content goes here</h1></td>
                                    <td>
                                    </td>
                                </tr>
                                <tr>
            ...
            <td width="250" rowspan="2"  align=center valign=middle>
                <span style="color: #ffffff"><h1>Extra controls &amp; content goes here</h1></span></td>
        </tr>
        <tr>
