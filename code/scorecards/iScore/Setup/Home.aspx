<%@ Page Language="C#" MasterPageFile="~/common/iMaster.master" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Setup_Home" Title="Untitled Page" %>
                                ...
                                <tr>
                                   ...
                                   <h1 style="text-align: center">
                                       ...
                                       <h4 style="text-align: center">
                                           &nbsp;<asp:Label ID="lblPageInfo" runat="server" Text="Please use the options in the menu to access the complete list of operations that
                                       you can perform"></asp:Label>&nbsp;&nbsp;&nbsp;</h4> 
